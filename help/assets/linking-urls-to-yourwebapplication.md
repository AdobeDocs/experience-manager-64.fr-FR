...
**Pour obtenir l’URL d’une ressource :**
...
1. Navigate to the *published* asset whose image preset URL or viewer preset URL you want to copy, and tap the asset to open it.
   ...
   N’oubliez pas que les URL ne peuvent être copiées *qu’après* la première *publication* des ressources. En outre, le paramètre prédéfini de visionneuse ou d’image doit également être publié.
...
**Pour obtenir l’URL d’une ressource statique** :
...
1. Sur la page **[!UICONTROL Cloud Services]**, faites défiler l’écran jusqu’à l’en-tête **[!UICONTROL Cloud Services Dynamic Media]**, puis appuyez sur **[!UICONTROL Afficher les configurations]**.
1. Sous **[!UICONTROL Configurations disponibles]**, appuyez sur le nom de la configuration de votre choix.
...
1. Sous **[!UICONTROL ID d’enregistrement]**, copiez le nom du client trouvé dans la dernière partie de l’ID.
...
1. On the **[!UICONTROL Dynamic Media Cloud Services Settings]** page, do the following:
   ...
   * Sous **[!UICONTROL ID d’enregistrement]**, copiez le nom du client trouvé dans la dernière partie de l’ID. Vous aurez besoin du nom du client copié plus loin dans ces étapes.
