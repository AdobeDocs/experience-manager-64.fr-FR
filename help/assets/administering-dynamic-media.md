...
>[!NOTE]
>
>Cette documentation décrit les fonctionnalités de Dynamic Media, qui sont directement intégrées à AEM. Si vous utilisez Dynamic Media Classic intégré à AEM, reportez-vous à la section [Documentation sur l’intégration de Dynamic Media Classic](/help/sites-administering/scene7.md).
>
...
Si vous administrez les médias dynamiques, les rubriques suivantes vous intéressent :
