---
title: 'Gestion des ressources composées et '
...
1. Using [AEM desktop app](https://helpx.adobe.com/experience-manager/desktop-app/aem-desktop-app.html), mount AEM Assets repository as a drive on your local machine. Dans le lecteur monté, accédez à l’emplacement de la ressource à référencer.
...
1. Click the **[!UICONTROL View Properties]** icon from the toolbar. Dans la page des propriétés, la liste des fichiers qui référencent l’actif en cours est visible sous la colonne ]**Références**[!UICONTROL  dans l’onglet ]**De base**[!UICONTROL .
