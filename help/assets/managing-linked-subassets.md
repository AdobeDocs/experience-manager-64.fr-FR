...
1. Enregistrez le fichier Photoshop sur le lecteur monté ou [chargez ](managing-assets-touch-ui.md#uploading-assets) dans le référentiel AEM.
...
Vous pouvez afficher un fichier de plusieurs pages, tel que PDF, INDD, PPT, PPTX et AI, à l’aide de la fonctionnalité Visionneuse de page d’AEM Assets. Ouvrez une ressource de plusieurs pages et cliquez sur **[!UICONTROL Afficher les pages]** dans le coin supérieur gauche de la page. La Visionneuse de page qui s’ouvre affiche les pages de la ressource et les commandes permettant de parcourir et de zoomer sur chaque page.
