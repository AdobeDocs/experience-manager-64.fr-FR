---
title: Utilisation de ressources Adobe Stock dans AEM Assets
...
Pour que l’intégration soit possible, l’[abonnement Adobe Stock entreprise](https://stockenterprise.adobe.com/) est requis et AEM 6.4 (Service Pack 2 minimum) doit être déployé. Pour plus d’informations sur les formules de service AEM 6.4, consultez ces [notes de mise à jour](/help/release-notes/sp-release-notes.md).
...
>[!NOTE]
>
>S’il existe plusieurs configurations Adobe Stock, sélectionnez celle de votre choix dans le panneau Préférences utilisateur (**[!UICONTROL AEM]** > **[!UICONTROL Icône Utilisateur]** > **[!UICONTROL Préférences utilisateur]** > **[!UICONTROL Configuration Adobe Stock]**).

## Utilisation et gestion de ressources Adobe Stock dans AEM {#use-and-manage-adobe-stock-assets-in-aem}
...
* Pour rechercher des ressources dans Adobe Stock et AEM Assets, cliquez sur l’icône ![search_icon](assets/search_icon.png).
