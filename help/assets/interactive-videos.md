...
![Image issue d’une vidéo](assets/chlimage_1-126.png) interactive pouvant faire l’objet d’un commerce *Capture d’une image vidéo à partir d’une vidéo interactive pouvant être utilisée dans le commerce.*
...
Regardez une présentation de 7 minutes et 30 secondes sur [la création de vidéos interactives](https://s7d5.scene7.com/s7viewers/html5/VideoViewer.html?videoserverurl=https://s7d5.scene7.com/is/content/&emailurl=https://s7d5.scene7.com/s7/emailFriend&serverUrl=https://s7d5.scene7.com/is/image/&config=Scene7SharedAssets/Universal_HTML5_Video_social&contenturl=https://s7d5.scene7.com/skins/&asset=S7tutorials/InteractiveVideo) [](https://outv.omniture.com?v=s4NHQ2dzqd7hIqWjeG2sIdyNWsTWyupA).\
(Bien que la présentation vidéo porte la marque Assets on Demand, les principes et étapes s’appliquent toujours à la vidéo interactive dans AEM Assets.)
...
Recherchez le titre **Exemple** dans certaines tâches de démarrage rapide. Il contient un court tutoriel reposant sur cette page web de démonstration de démarrage qui n’a *pas encore* d’interactivité ajoutée :
...
Les **exemples** contribuent à illustrer les étapes de l’intégration de vidéos interactives sur votre propre site web.
...
**Flux de production** vidéo interactif :
...
Voir [(Facultatif) Création d’un paramètre prédéfini de visionneuse](managing-viewer-presets.md#creating-a-new-viewer-preset) et [ Aspects spéciaux de la création d’un paramètre prédéfini de visionneuse de vidéos interactives](managing-viewer-presets.md#special-considerations-for-creating-an-interactive-viewer-preset).
...
Une fois le paramètre prédéfini de la visionneuse enregistré, son état est automatiquement définit sur **[!UICONTROL On]**(Activé) dans la page Paramètres prédéfinis de la visionneuse. Cet état signifie qu’il est visible dans le composant Dynamic Media et chaque fois que vous prévisualisez une vidéo avec ce paramètre prédéfini. **** Veillez également à publier manuellement votre nouveau paramètre prédéfini de visionneuse.
...
1. Téléchargez la vidéo et les ressources miniatures associées dans le dossier ou les dossiers de votre choix.
   ...
   Reportez-vous à la section [Téléchargement des ressources](managing-assets-touch-ui.md).
...
**[!UICONTROL Les options Annuler]** et **[!UICONTROL Rétablir]** , situées dans le coin supérieur droit de la page, sont prises en charge pendant la session de création/modification en cours.
...
1. (Facultatif) Faites glisser la barre sur le **[!UICONTROL curseur d’échelle du journal]** vers la gauche pour effectuer un zoom avant ou vers la droite pour effectuer un zoom arrière, en contrôlant ainsi le niveau de détail des segments que vous avez ajoutés.
...
1. Supprimez la vidéo statique et remplacez le code par le code incorporé ou l’URL que vous avez copié à partir des ressources AEM, en l’état.

   Le code incorporé copié est défini pour un environnement réactif. Il doit donc automatiquement s’adapter à la zone précédemment occupée par la vidéo statique.
