...
+ [Notes de mise à jour AEM Ressources 6.4](https://experienceleague.adobe.com/docs/experience-manager-64/release-notes/assets.html)
...
+ Dynamic Media{#dynamic}
   ...
   + [Vidéo](s7-video.md)
   + [Ajouter les fonctionnalités de Dynamic Media Classic à votre page](scene7.md)
...
+ Ressources 3D {#three-d}
   + [Notes de mise à jour AEM 3D](https://experienceleague.adobe.com/docs/experience-manager-64/assets/three-d/assets-3d.html)
