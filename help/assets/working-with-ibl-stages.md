...
* **Image** de l&#39;environnement d&#39;éclairage diffus - Ce type d&#39;image doit être une image HDR, mais peut être relativement petite, car l&#39;image sera fortement filtrée avant de l&#39;utiliser pour l&#39;éclairage diffus.
* **Image** de l&#39;environnement de réflexion : ce type d&#39;image est utilisé pour créer des reflets dans les surfaces d&#39;objet. Il peut s’agir d’une image RVB 8 bits standard d’une taille et d’une résolution permettant d’obtenir la qualité souhaitée et des reflets nets. Si une image HDR est spécifiée, AEM 3D la convertit en RVB 8 bits avant d’utiliser un algorithme propriétaire.
...
## Augmentation du diamètre d&#39;arrière-plan sphérique d&#39;une scène IBL {#increasing-the-spherical-background-diameter-of-an-ibl-stage}

Les scènes IBL utilisent des images d&#39;arrière-plan sphériques de 20 mètres de diamètre par défaut. Ces étapes fonctionnent bien pour les objets jusqu&#39;à 10 mètres. Cependant, si vous affichez des objets plus grands, vous pouvez augmenter le diamètre d’arrière-plan sphérique d’une scène IBL.

**Pour augmenter le diamètre d&#39;arrière-plan sphérique d&#39;une scène** IBL:

1. Dans CRXDE Lite, accédez à la scène dont vous souhaitez augmenter le diamètre d’arrière-plan sphérique. Par exemple :
...
1. Définissez la propriété `dam:gPlaneRadius` sur la valeur de millimètre souhaitée.
   ...
   Pour optimiser l’efficacité du rendu, Adobe recommande de limiter cette valeur à environ la plus grande dimension de l’objet le plus volumineux que vous prévoyez d’afficher sur la scène.
