...
1. Pour filtrer les propriétés XMP bloquées après avoir appliqué le filtrage par liste autorisée, spécifiez celles indiquées dans la variable **[!UICONTROL Noms XML bloqués pour le filtrage XMP]** de la boîte. Enregistrez les modifications.
