...
1. Dans Dynamic Media Classic, [configurez un transfert et un codage FTP planifiés vers Scene7 (système automatisé)](https://help.adobe.com/en_US/scene7/using/WS70B173EC-4CAD-4b4c-BF9C-43A11F3A5950.html).
...
1. Cliquez sur **[!UICONTROL Télécharger]** pour télécharger la vidéo maître. Le téléchargement et le codage des vidéos sont terminés une fois le flux de travaux de mise à jour des actifs de gestion des actifs numériques terminé et **[!UICONTROL Publier sur Scene7]** comporte une coche.
   ...
   Le glissement de la vidéo maître de la gestion des actifs numériques sur le composant vidéo permet d’accéder à *tous* les rendus proxy codés Scene7 pour diffusion.
