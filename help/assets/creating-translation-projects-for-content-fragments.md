...
description: Découvrez comment traduire des fragments de contenu.
...
[!DNL Experience Manager] permet de traduire des fragments de contenu qui incluent divers types de ressources et collections multimédia. Si vous traduisez un fragment de contenu qui comprend des ressources intégrées, les copies traduites de ces ressources sont stockées sous la racine de la langue cible.
