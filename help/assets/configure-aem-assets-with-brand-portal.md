...
* Si vous êtes un partenaire Adobe, utilisez le [de formation des partenaires](https://adobe.allegiancetech.com/cgi-bin/qwebcorporate.dll?idx=82357Q) Adobe pour demander AEM 6.4.
...
Vous devez exécuter le  de vérification suivant lors de la suppression de la configuration existante.
