...
* **** Reprendre : Reprenez la relation en direct afin qu’une copie en direct recommence à recevoir les mises à jour de la source. Voir [Action de reprise](#suspend-and-resume-relationship).
...
1. Sélectionnez une ressource ou un dossier de Live Copy. Cliquez sur **[!UICONTROL Propriétés]** dans la barre d’outils. Vous pouvez également utiliser le raccourci clavier `p`.
1. Cliquez sur la **[!UICONTROL source de la Live Copy]**. Click **[!UICONTROL Rollout]** from the toolbar.
...
Pour connaître les états et les informations liés à une action de synchronisation, voir [Informations et états de toutes les copies dynamiques d’un dossier](#information-status-of-all-lcs-of-folder).
...
Vous pouvez également suspendre ou reprendre rapidement les relations de plusieurs ressources dans un dossier Live Copy à partir de la console **[!UICONTROL Aperçu de la Live Copy]**. Voir [Agir sur plusieurs ressources dans des dossiers de la Live Copy](#take-actions-on-many-assets-in-lcfolder).
...
Vous pouvez également désolidariser rapidement plusieurs ressources d’un dossier de Live Copy dans la console **[!UICONTROL Aperçu de la Live Copy]**. Voir [Agir sur plusieurs ressources dans des dossiers de la Live Copy](#take-actions-on-many-assets-in-lcfolder).
...
1. Sélectionnez un dossier source. Cliquez sur **[!UICONTROL Propriétés]** dans la barre d’outils. Vous pouvez également utiliser le raccourci clavier p.
1. Cliquez sur la source de la Live Copy. Pour ouvrir la console, cliquez sur **[!UICONTROL Aperçu de la Live Copy]**.
