...
# Gestion des droits numériques dans AEM Assets {#digital-rights-management-in-assets}
...
Lorsqu’une ressource arrive à expiration, un indicateur le signale sur la carte.
...
### Téléchargement des ressources DRM {#downloading-drm-assets}
