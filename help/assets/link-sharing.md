...
description: Comment partager des ressources, des dossiers et des collections dans les ressources AEM en tant qu’URL de parties externes.
contentOwner: AG
...
>[!NOTE]
>
>Vous devez disposer de l’autorisation Modifier la liste de contrôle d’accès sur les dossiers et les fichiers que vous souhaitez partager en tant que lien.
...
1. From the toolbar, click/tap the **[!UICONTROL Share Link]** ![assets share icon](assets/assets_share.png).
   ...
   >[!NOTE]
   >
   >Pour partager des liens de votre auteur AEM vers des entités externes, n’exposez que les URL suivantes utilisées pour le partage de liens, pour les demandes GET. Bloquez d’autres URL pour vous assurer que votre déploiement AEM est sécurisé.
   >
...
1. Pour afficher les ressources que vous avez partagées en tant que liens, accédez à l’interface utilisateur Assets, puis cliquez/appuyez sur l’icône de **[!UICONTROL navigation globale]**. Choose **[!UICONTROL Navigation]** from the list to display the Navigation pane.
...
1. Cliquez/appuyez sur le logo AEM, puis sélectionnez **[!UICONTROL Outils > Opérations > Console web]**.
...
* Si vous ne pouvez pas partager des fichiers à l’aide de la fonctionnalité de partage de liens, assurez-vous que vous disposez des autorisations appropriées. Reportez-vous à [Partager des fichiers](#share-assets).
