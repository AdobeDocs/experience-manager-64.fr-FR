...
Assurez-vous que les personnages appropriés sont enregistrés pour prendre les mesures appropriées [examens de certification](https://training.adobe.com/certification/exams.html#p=1&amp;solution=adobeExperienceManager).

## AEM certifié {#aem-certified}

Assurez-vous que le personnage approprié a transmis les [examens de certification](https://training.adobe.com/certification/exams.html#p=1&amp;solution=adobeExperienceManager).
...
Un contrat finalisé et signé est requis avant de poursuivre le projet. Cela repose sur la variable [Version préliminaire du contrat](#contract-draft).
...
Ces plans décrivent en détail l’exécution des tests pour chaque phase de développement et reposent sur la méthode [Stratégie de test](#testing-strategy).
