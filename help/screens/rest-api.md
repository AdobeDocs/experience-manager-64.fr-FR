...
Les autres ressources auront des actions différentes exposées. En voici quelques-unes :
- Channels: `boardcast-command`, `broadcast-command-with-ack`, `unassign`
- Affichages: `boardcast-command`, `broadcast-command-with-ack`
- Périphériques: `boardcast-command`, `broadcast-command-with-ack`