...
1. [AEM 6.4](https://helpx.adobe.com/experience-manager/6-4/release-notes.html) ou [AEM 6.3](https://helpx.adobe.com/experience-manager/6-3/release-notes.html) + dernier Feature Pack Screens
...
Les étapes du tutoriel et les captures d’écran sont effectuées à l’aide de [CRXDE-Lite](http://localhost:4502/crx/de/index.jsp). Les IDE [Eclipse](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/aem-eclipse.html) ou [IntelliJ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/ht-intellij.html) peuvent également être utilisés pour suivre le tutoriel. Vous trouverez plus d’informations sur l’utilisation d’un IDE pour le développement [avec AEM ici.](https://helpx.adobe.com/experience-manager/kt/sites/using/getting-started-wknd-tutorial-develop/part1.html#eclipse-ide)

>[!NOTE]
>
>Avant de commencer ce didacticiel, il est recommandé d’avoir examiné les éléments suivants :
>
>1. [Présentation des écrans AEM](https://helpx.adobe.com/experience-manager/kt/screens/using/screens-concepts-feature-video-understand.html)
...
1. Ajoutez les propriétés suivantes à la bibliothèque cliente partagée :
   ...
   * `categories`| Chaîne[] | `cq.screens.components`
   ...
   Il est recommandé de ne jamais exposer directement les chemins d’accès à /apps dans un environnement de production. La propriété allowProxy garantit que la bibliothèque cliente CSS et JS est référencée par le biais d’un préfixe of/etc.clientlibs. Vous trouverez [ici](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/clientlibs.html#main-pars_title_8ced) plus d’informations sur la propriété allowProxy.
