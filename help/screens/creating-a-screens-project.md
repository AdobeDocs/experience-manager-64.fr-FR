...
Vous pouvez également utiliser le lien d’accès direct : [http://localhost:4502/screens.html/content/screens.](http://localhost:4502/screens.html/content/screens)
...
Une fois que vous aurez créé votre propre projet, reportez-vous à la section [**Gestion des canaux **](/help/screens/managing-channels.md)pour créer et gérer le contenu de votre canal.
