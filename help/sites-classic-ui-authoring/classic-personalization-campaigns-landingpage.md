...
1. Ouvrez la page d’importateur que vous avez [créé précédemment](#creatingablankcanvaspage). Une liste déroulante contenant un texte indique : **Zip**.
...
Lorsque vous importez le bloc de conception, la barre d’outils suivante est disponible dans la partie supérieure de la landing page :
