...
Ajouter le [!UICONTROL Dynamic Media] ou [!UICONTROL Média interactif] est identique à l’ajout d’un composant à une page. Le [!UICONTROL Dynamic Media] et [!UICONTROL Média interactif] Les composants sont décrits en détail dans les sections suivantes.
...
1. Revenir à **[!UICONTROL Modifier]** en cliquant sur l’icône de crayon dans la [!UICONTROL Sidekick].
1. Faites glisser le **[!UICONTROL Dynamic Media]** ou **[!UICONTROL Média interactif]** du composant **[!UICONTROL Autre]** Regroupez dans le sidekick la page à l’emplacement souhaité.
...
>[!NOTE]
>
>Lorsque vous ajoutez le [!UICONTROL Dynamic Media] et **[!UICONTROL Paramètres Dynamic Media]** est vide ou vous ne pouvez pas ajouter correctement une ressource, vérifiez les points suivants :
>
...
Le [!UICONTROL Dynamic Media] permet d’ajouter des images dynamiques, notamment des visionneuses d’images, à 360° et des visionneuses de supports variés. Vous pouvez effectuer un zoom avant et arrière, faire pivoter une image dans une visionneuse à 360° ou sélectionner une image dans un autre type de visionneuse.
...
Vous pouvez modifier les paramètres Dynamic Media suivants en cliquant sur **[!UICONTROL Modifier]** dans le composant, puis cliquez sur l’icône **[!UICONTROL Paramètres Dynamic Media]** .

![chlimage_1-73](assets/chlimage_1-73.png)

>[!NOTE]
>
>Par défaut, le composant d’image Dynamic Media est adaptatif. Si vous souhaitez lui donner une taille fixe, définissez-la dans le composant du **[!UICONTROL Avancé]** avec l’onglet **[!UICONTROL Largeur]** et **[!UICONTROL Hauteur]** propriétés.
...
Vous pouvez modifier les éléments suivants : [!UICONTROL Paramètres avancés] en cliquant **[!UICONTROL Modifier]** dans le composant.
...
Utilisez la variable [!UICONTROL Dynamic Media] pour ajouter une vidéo dynamique à vos pages web. Lorsque vous modifiez le composant, vous pouvez choisir d’utiliser un paramètre prédéfini de la visionneuse de vidéos pour lire la vidéo sur la page.

![chlimage_1-74](assets/chlimage_1-74.png)

Vous pouvez modifier les éléments suivants : [!UICONTROL Paramètres Dynamic Media] en cliquant **[!UICONTROL Modifier]** dans le composant.
...
Vous pouvez modifier les éléments suivants : [!UICONTROL Avancé] paramètres en cliquant sur **[!UICONTROL Modifier]** dans le composant.
...
Le [!UICONTROL Média interactif] est dynamique ; selon que vous ajoutez une image ou une vidéo, vous disposez de différentes options. En outre, la visionneuse est réactive. En d’autres termes, la taille de l’écran change automatiquement en fonction de la taille de l’écran. Toutes les visionneuses sont des visionneuses HTML5.
