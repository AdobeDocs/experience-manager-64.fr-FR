...
* **[Tableau de bord](#dashboard)** Le tableau de bord se compose de quatre volets :
   ...
   * [Listes](#lists)
      ...
      Ce volet affiche les listes que vous avez déjà créées, ainsi que le nombre de pistes figurant dans chacune d’elles. Il vous permet de créer une liste en partant de zéro ou en important des pistes.
...
* **Dans le volet de gauche** :
   ...
   Vous pouvez consulter la liste de toutes les marques et campagnes.
...
* **Dans le volet de droite** :
   ...
   Des icônes sont affichées pour chaque marque (les campagnes historiques ne sont pas affichées).
