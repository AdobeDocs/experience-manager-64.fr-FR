...
+ Prise en main {#getting-started}
   ...
   + Tutoriel : Créer votre premier formulaire adaptatif {#create-first-adaptive-form}
      + [Tutoriel : Créer votre premier formulaire adaptatif](using/create-your-first-adaptive-form.md)
      ...
      + [Tutoriel : Application de règles aux champs de formulaire adaptatif l](using/apply-rules-to-adaptive-form-fields.md)
      + [Tutoriel : Donner un style à votre formulaire adaptatif](using/style-your-adaptive-form.md)
...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur OSGi {#osgi-installation}
      + [Plateformes prises en charge pour AEM forms on OSGi](https://helpx.adobe.com/fr/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
      ...
      + [Installation et configuration d’un workflow basé sur l’utilisation de Forms sur OSGi](using/installing-configuring-forms-centric-workflow-on-osgi.md)
   ...
   + Installation d’AEM Forms on JEE {#jee-installation}
...
+ Mettre à niveau AEM Forms {#upgrade-aem-forms}
   ...
   + Mise à niveau d’AEM Forms sur OSGi {#aem-forms-osgi-upgrade}
      + [Mise à niveau vers AEM 6.4 forms on OSGi](using/upgrade-forms-osgi.md)
   ...
   + Mise à niveau d’AEM Forms on JEE {#aem-forms-jee-upgrade}
      + [Préparation à la mise à niveau d’AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareupgrade_64_fr)
      + [Aide-mémoire et planification de la mise à niveau d’Adobe Experience Manager Forms on JEE](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64_fr)
      + [Mise à niveau vers AEM 6.4 forms on JEE](using/upgrade-forms-jee.md)
...
+ Gestion d’AEM Forms {#manage-administer-aem-forms}
   ...
   + Gestion des données utilisateur {#handling-user-data}
      ...
      + [Gestion des utilisateurs de Forms](using/user-management-handling-user-data.md)
   ...
   + Renforcement de l’environnement AEM Forms {#hardening-aem-forms-environment}
      ...
      + [Considérations générales sur la sécurité d’AEM Forms on JEE](using/general-security-considerations.md)
      + [Sécurisation de votre environnement d’AEM Forms sur JEE](using/hardening-aem-forms-jee-environment.md)
      + [Configuration des paramètres d’administration sécurisée d’AEM Forms on JEE](using/configuring-secure-administration-settings-aem.md)
...
+ Aide à l’administrateur d’AEM Forms on JEE {#administrator-help}
...
+ Rapports de workflow {#process-reporting}
   ...
   + [Prise en main du reporting de processus](/help/forms/using/process-reporting/install-start-process-reporting.md)
   + [Fonctionnement des rapports de traitement](/help/forms/using/process-reporting/process-reporting-architecture.md)
   + [Rapports prédéfinis dans les rapports de processus](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
   ...
   + [Dépannage des rapports de processus](/help/forms/using/process-reporting/troubleshooting-process-management.md)
+ Guides de référence pour les développeurs {#developer-reference}
   ...
   + Programmation avec AEM Forms on JEE {#programming-aem-forms-jee}
      ...
      + Java API Quick Start - Exemples de code {#java-api-quick-start-code-examples}
         ...
         + [API Java de Document Management Service (obsolète) : démarrage rapide (SOAP)](developing/document-management-service-deprecated-java.md)
         + [Démarrage rapide de l’API Java du service Document Security (SOAP)](developing/document-security-service-java-api.md)
         + [API Java du service Encryption QuickStart (SOAP)](developing/encryption-service-java-api-quick.md)
         + [API Java du registre des points de terminaison QuickStart (SOAP)](developing/endpoint-registry-java-api-quick.md)
         + [Démarrage rapide de l’API Java du service d’intégration des données de formulaire (SOAP)](developing/form-data-integration-service-java.md)
         + [Démarrages rapides de l’API Forms Service](developing/forms-service-api-quick-starts.md)
         + [API Java Generate PDF Service QuickStart (SOAP)](developing/generate-pdf-service-java-api.md)
         ...
         + [API Java Output Service Quick Start (SOAP)](developing/output-service-java-api-quick.md)
         ...
         + [API Java de Task Manager Service QuickStart (SOAP)](developing/task-manager-service-java-api.md)
         + [Démarrage rapide de l’API Java User Manager (SOAP)](developing/user-manager-java-api-quick.md)
      ...
      + Exécution d’opérations de service à l’aide d’API {#performing-service-operations-using-apis}
         ...
         + [Conversion entre les formats de fichier et PDF](developing/converting-file-formats-pdf.md)
