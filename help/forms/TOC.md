...
audience: end-user
user-guide-title: Guide Adobe Experience Manager 6.4
...
# Guide Adobe Experience Manager 6.4 {#forms}
...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur OSGi {#osgi-installation}
      + [Plates-formes prises en charge pour les formulaires AEM sur OSGi](https://helpx.adobe.com/fr/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
