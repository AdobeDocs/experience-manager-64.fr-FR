...
+ [Guide de l’utilisateur d’AEM 6.4 Forms](home.md)
+ Notes de mise à jour {#release-notes-new-features}
   ...
   + [Fonctions obsolètes](https://docs.adobe.com/content/help/en/experience-manager-64/release-notes/deprecated-removed-features.html)
+ Prise en main {#getting-started}
   ...
   + Tutorial: Create your First Adaptive Form {#create-first-adaptive-form}
      ...
      + [Didacticiel : Mise en forme du formulaire adaptatif](using/style-your-adaptive-form.md)
   ...
   + AEM Forms Reference Collaterals {#aem-forms-reference-collaterals}
      ...
      + [Site de référence de renouvellement d&#39;assurance automobile We.Finance](/help/forms/using/finance-auto-insurance-renewal-reference-site-walkthrough.md)
...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur OSGi {#osgi-installation}
      + [Plates-formes prises en charge pour AEM Forms sur OSGi](https://helpx.adobe.com/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
      + [Installation et configuration des services](using/install-configure-document-services.md)
      + [Installation et configuration des fonctionnalités de capture de données](using/installing-configuring-aem-forms-osgi.md)
      + [Installation et configuration du flux de travail centré sur Forms sur OSGi](using/installing-configuring-forms-centric-workflow-on-osgi.md)
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [Installation et déploiement d’AEM Forms sur JEE à l’aide de JBoss clé en main](http://www.adobe.com/go/learn_aemforms_installTurnkey_64)
      + [Installation et configuration de  serveur de sécurité uniquement](using/installing-and-configuring-the-document-security-server.md)
      + [Préparation à l’installation du serveur unique AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareInstallsingle_64)
      + [Installation et déploiement d’AEM Forms sur JEE pour JBoss](http://www.adobe.com/go/learn_aemforms_installJBoss_64)
      + [Installation et déploiement d’AEM Forms sur JEE pour WebLogic](http://www.adobe.com/go/learn_aemforms_installWebLogic_64)
      + [Installation et déploiement d’AEM Forms sur JEE pour WebSphere](http://www.adobe.com/go/learn_aemforms_installWebSphere_64)
      + [Installation d’AEM Forms Workbench](http://help.adobe.com/en_US/AEMForms/6.1/InstallWorkbench/index.html)
      + [Installation et configuration de Designer](using/installing-configuring-designer.md)
      + [Préparation à l’installation de la grappe de serveurs AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareInstallcluster_64)
      + [Configuration d’AEM Forms sur JEE sur une grappe JBoss](http://www.adobe.com/go/learn_aemforms_clusterJBoss_64)
      + [Configuration d’AEM Forms sur JEE sur une grappe WebLogic](http://www.adobe.com/go/learn_aemforms_clusterWebLogic_64)
      + [Configuration d’AEM Forms sur JEE sur une grappe WebSphere](http://www.adobe.com/go/learn_aemforms_clusterWebSphere_64)
   + Configurer AEM Forms {#configure-aem-forms}
      ...
      + [Configuration de Connector for Microsoft SharePoint](http://help.adobe.com/en_US/AEMForms/6.1/SharePointConfig/index.html)
...
+ Mise à niveau d’AEM Forms {#upgrade-aem-forms}
   ...
   + Mise à niveau d’AEM Forms sur JEE {#aem-forms-jee-upgrade}
      + [Préparation à la mise à niveau d’AEM Forms](http://www.adobe.com/go/learn_aemforms_prepareupgrade_64)
      + [Aide-mémoire et planification de la mise à niveau](http://www.adobe.com/go/learn_aemforms_upgrade_checklist_64)
      + [Mise à niveau vers AEM Forms 6.4 sur JEE](using/upgrade-forms-jee.md)
      + [Mise à niveau d’une version d’AEM Forms vers AEM Forms 6.4 sur JEE pour JBoss](http://www.adobe.com/go/learn_aemforms_upgradeJBoss_64)
      ...
      + [Mise à niveau d’une version d’AEM Forms vers AEM Forms 6.4 sur JEE pour JBoss clé en main](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_64)
      ...
      + [Mise à niveau d’une version d’AEM Forms vers AEM Forms 6.4 sur JEE pour WebLogic](http://www.adobe.com/go/learn_aemforms_upgradeWebLogic_64)
      ...
      + [Mise à niveau d’une version d’AEM Forms vers AEM Forms 6.4 sur JEE pour WebSphere](http://www.adobe.com/go/learn_aemforms_upgradeWebSphere_64)
      + [Mise à niveau de LiveCycle ES4 SP1 vers AEM Forms sur JEE pour WebSphere](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/upgrade-turnkey-livecycle.pdf)
+ Gestion d’AEM Forms {#manage-administer-aem-forms}
   ...
   + Handling user data {#handling-user-data}
      ...
      + [Forms JEE](using/forms-workflow-jee-handling-user-data.md)
   ...
   + Hardening AEM Forms Environment {#hardening-aem-forms-environment}
      ...
      + [Renforcement de votre AEM Forms sur JEE ](using/hardening-aem-forms-jee-environment.md)
      + [Configuration des paramètres d’administration sécurisée pour AEM Forms sur JEE](using/configuring-secure-administration-settings-aem.md)
...
+ Formulaires adaptatifs - Création avancée {#adaptive-forms-advanced-authoring}
   ...
   + [Messages d’erreur de validation standard pour les formulaires adaptatifs](using/standard-validation-error-messages-adaptive-forms.md)
...
+ Espace de travail AEM Forms {#use-aem-forms-workspace}
   ...
   + [Personnalisation de la page  détails du](using/customizing-task-details-page.md)
...
+ Document Security {#use-document-security}
   + [Offres de Document Security](using/document-security-offerings.md)
...
+ Concepteur Forms {#use-forms-designer}
   ...
   + [Didacticiels de mise en route de Designer](http://www.adobe.com/go/learn_aemforms_designer_quick_start_64)
   + [Designer – Exemples](http://www.adobe.com/go/learn_aemforms_designer_samples_64)
   + [Concepts de base des scripts de Designer](http://www.adobe.com/go/learn_aemforms_scriptingBasics_64)
   + [Designer - Guide de référence pour les scripts](http://www.adobe.com/go/learn_aemforms_scriptingReference_64)
   + [Guide de référence pour Designer FormCalc](http://www.adobe.com/go/learn_aemforms_formCalc_64)
...
+ Rapports de workflow {#process-reporting}
   + [Introduction aux  de processus](/help/forms/using/process-reporting/introduction-process-reporting.md)
   + [Prise en main du de processus](/help/forms/using/process-reporting/install-start-process-reporting.md)
   + [Fonctionnement du de processus](/help/forms/using/process-reporting/process-reporting-architecture.md)
   + [Rapports prédéfinis dans les  de processus](/help/forms/using/process-reporting/pre-defined-reports-in-process-reporting.md)
   + [Rapports personnalisés dans le de processus](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
   + [ad hoc dans le de processus](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)
   + [Résolution des problèmes du de processus](/help/forms/using/process-reporting/troubleshooting-process-management.md)
+ Guides de référence pour les développeurs {#developer-reference}
   ...
   + [Référence API Java pour AEM Forms](https://helpx.adobe.com/experience-manager/6-4/forms/javadocs/index.html)
   ...
   + [Guide de référence du service Assembler et de DDX](http://www.adobe.com/go/learn_aemforms_ddxRef_64)
   + [Aide de Workbench](http://www.adobe.com/go/learn_aemforms_workbench_64)
   + Programmation avec AEM Forms sur JEE {#programming-aem-forms-jee}
      + Présentation de la programmation avec AEM Forms sur JEE {#introduction-programming-aem-forms-jee}
         ...
         + [du service](developing/service-container.md)
      +  rapide de l’API Java - Exemples de code {#java-api-quick-start-code-examples}
         + [rapide JavaAPI client d’Application Manager (SOAP)](developing/application-manager-client-java-api.md)
         + [rapide de l’API Java du service Application Manager (SOAP)](developing/application-manager-service-java-api.md)
         + [API Java du service Assembler QuickStart (SOAP)](developing/assembler-service-java-api-quick.md)
         + [rapide de l’API Java du service des extensions d’Acrobat Reader DC (SOAP)](developing/acrobat-reader-dc-extensions-service.md)
         + [Service de sauvegarde et de restauration APIQuick](developing/backup-restore-service-api-quick.md)
         + [Java APIQuick du service Barcoded Forms (SOAP)](developing/barcoded-forms-service-java-api.md)
         + [Composants et services Java APIQuick (SOAP)](developing/components-services-java-api-quick.md)
         ...
         + [Service de gestion des  (obsolète)rapide API Java (SOAP)](developing/document-management-service-deprecated-java.md)
         + [de sécurité JavaAPI Quick (SOAP)](developing/document-security-service-java-api.md)
         + [API Java du service de chiffrement QuickStart (SOAP)](developing/encryption-service-java-api-quick.md)
         + [API Java du registre des points de fin QuickStart (SOAP)](developing/endpoint-registry-java-api-quick.md)
         + [rapide JavaAPI du service d’intégration des données de formulaire (SOAP)](developing/form-data-integration-service-java.md)
         + [rapide de l’API du service Forms](developing/forms-service-api-quick-starts.md)
         + [API Java du service Generate PDF QuickStart (SOAP)](developing/generate-pdf-service-java-api.md)
         + [rapide de l’API d’appel](developing/invocation-api-quick-starts.md)
         + [rapide de l’API Java LiveCycleProcess (SOAP)](developing/livecycleprocess-java-api-soap-quick.md)
         + [rapide de l’API Java du service Output (SOAP)](developing/output-service-java-api-quick.md)
         + [PDF Utilities Service Java APIQuick (SOAP)](developing/pdf-utilities-service-java-api.md)
         + [rapide de l’API du service Repository](developing/repository-service-api-quick-starts.md)
         + [API Java du service Signature QuickStart (SOAP)](developing/signature-service-java-api-quick.md)
         + [API Java du service Gestionnaire de  QuickStart (SOAP)](developing/task-manager-service-java-api.md)
         + [rapide de l’API Java User Manager (SOAP)](developing/user-manager-java-api-quick.md)
         + [XMP Utilities Service Java APIQuick(SOAP)](developing/xmp-utilities-service-java-api.md)
      + Appel d’AEM Forms sur JEE à l’aide d’API {#invoking-aem-forms-jee-apis}
         ...
         + [Création d’applications Flash Builder qui effectuent une authentification SSO à l’aide de jetons HTTP](developing/creating-flash-builder-applications-perform.md)
      + Exécution d’opérations de service à l’aide d’API {#performing-service-operations-using-apis}
         ...
         + [Rendu des formulaires](developing/rendering-forms.md)
         + [Assemblage de documents PDF](developing/assembling-pdf-documents.md)
         + [Assemblage par programmation de PDF](developing/programmatically-assembling-pdf-documents.md)
         + [Conversion entre formats de fichier et PDF](developing/converting-file-formats-pdf.md)
         + [Désassemblage programmatique des PDF](developing/programmatically-disassembling-pdf-documents.md)
         + [Assemblage de  PDF chiffrés](developing/assembling-encrypted-pdf-documents.md)
         + [Assemblage de plusieurs fragments XDP](developing/assembling-multiple-xdp-fragments.md)
         + [Assemblage de  à l’aide de la numérotation Bates](developing/assembling-documents-using-bates-numbering.md)
         + [Assemblage de  PDF non interactifs](developing/assembling-non-interactive-pdf-documents.md)
         + [Assemblage de  PDF avec des signets](developing/assembling-pdf-documents-bookmarks.md)
         ...
         + [Création de   de quiRendu des formulaires](developing/creating-web-applications-renders-forms.md)
         + [Création de  PDF avec des données XML envoyées](developing/creating-pdf-documents-submitted-xml.md)
         + [Démonter un PDF à l’aide de l’API du service Web](developing/disassemble-pdf-document-using-web.md)
         + [Détermination de la conformité des  à la norme PDF/A](developing/determining-whether-documents-pdf-a.md)
         + [Création dynamique d’un DDX](developing/dynamically-creating-ddx-documents.md)
         + [Gestion des formulaires envoyés](developing/handling-submitted-forms.md)
         + [Optimisation des performances du service Forms](developing/optimizing-performance-forms-service.md)
         + [Transmission du  à FormsService](developing/passing-documents-forms-service.md)
         + [Préremplissage des formulaires avec des mises en page souples](developing/prepopulating-forms-flowable-layouts.md)
         ...
         + [Validation du DDX](developing/validating-ddx-documents.md)
         + [Conversion de fichiers PDF en fichiers Postscript et Image](developing/converting-pdf-postscript-image-files.md)
         + [Conversion de PostScript en PDF](developing/converting-postscript-pdf-documents.md)
         + [Création de flux de sortie](developing/creating-document-output-streams.md)
         + [Signature numérique et certification des](developing/digitally-signing-certifying-documents.md)
         + [Chiffrement et déchiffrement du PDF](developing/encrypting-decrypting-pdf-documents.md)
         ...
         + [Utilisation d’un PDF/A](developing/pdf-a-documents.md)
         ...
         + [Gestion programmatique des points de fin](developing/programmatically-endpoints.md)
         + [Gestion programmatique des noeuds de préférences](developing/programmatically-preferences-nodes.md)
         + [Protection des  par des stratégies](developing/protecting-documents-policies.md)
         + [Validation d’un DDX à l’aide de l’API du service Web](developing/validate-ddx-document-using-web.md)