...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur OSGi {#osgi-installation}
      + [Plateformes prises en charge pour AEM Forms sur OSGi](https://helpx.adobe.com/fr/experience-manager/6-4/sites/deploying/using/technical-requirements.html)
      ...
      + [Installation et configuration du flux de travaux axé sur les formulaires sur OSGi](using/installing-configuring-forms-centric-workflow-on-osgi.md)
...
+ Gestion d’AEM Forms {#manage-administer-aem-forms}
   ...
   + Handling user data {#handling-user-data}
      ...
      + [Gestion des utilisateurs de formulaires](using/user-management-handling-user-data.md)
...
+ Guides de référence pour les développeurs {#developer-reference}
   ...
   + Programmation avec AEM Forms sur JEE {#programming-aem-forms-jee}
      ...
      + Début rapide de l’API Java - Exemples de code {#java-api-quick-start-code-examples}
         ...
         + [Début rapide de l&#39;API Java d&#39;Acrobat Reader DC Extensions Service (SOAP)](developing/acrobat-reader-dc-extensions-service.md)
         + [Débuts APIQuick du service de sauvegarde et de restauration](developing/backup-restore-service-api-quick.md)
         + [Début APIQuick Java du service Barcoded Forms (SOAP)](developing/barcoded-forms-service-java-api.md)
         ...
         + [API Java de Distiller Service QuickStart (SOAP)](developing/distiller-service-java-api-quick.md)
         ...
         + [Débuts rapides de l’API Forms Service](developing/forms-service-api-quick-starts.md)
      ...
      + Exécution d’opérations de service à l’aide d’API {#performing-service-operations-using-apis}
         ...
         + [Préremplissage des formulaires avec des dispositions souple](developing/prepopulating-forms-flowable-layouts.md)
