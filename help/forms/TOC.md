...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur JEE {#jee-installation}
      ...
      + [Installer et déployer AEM Forms sur JEE à l’aide de JBoss clé en main](http://www.adobe.com/go/learn_aemforms_installTurnkey_64_fr)
...
+ Mettre à niveau AEM Forms {#upgrade-aem-forms}
   ...
   + Mettre à niveau AEM Forms sur OSGi {#aem-forms-osgi-upgrade}
      + [Mettre à niveau vers AEM Forms 6.4 sur OSGi](using/upgrade-forms-osgi.md)
...
+ Formulaires adaptatifs - Création avancée {#adaptive-forms-advanced-authoring}
   ...
   + [Utilisation d’Acrobat Sign dans un formulaire adaptatif](using/working-with-adobe-sign.md)
   ...
   + [Intégration d’Acrobat Sign à AEM Forms](using/adobe-sign-integration-adaptive-forms.md)
   + [Création et gestion de révisions des actifs d’un formulaire](using/create-reviews-forms.md)
   + [Messages d’erreur de validation standard des formulaires adaptatifs](using/standard-validation-error-messages-adaptive-forms.md)
...
+ Guides de référence pour les développeurs {#developer-reference}
   ...
   + [Guide de référence du service Assembler et de DDX](http://www.adobe.com/go/learn_aemforms_designer_64_fr)
   ...
   + Programmation avec AEM Forms sur JEE {#programming-aem-forms-jee}
      ...
      + Démarrage rapide de l’API Java - Exemples de code {#java-api-quick-start-code-examples}
         ...
         + [Didacticiel de mise en route (SOAP) de lʼAPI Java du service Extensions Acrobat Reader DC](developing/acrobat-reader-dc-extensions-service.md)
