...
+ Installer et configurer AEM Forms {#install-aem-forms}
   ...
   + Installer AEM Forms sur OSGi {#osgi-installation}
      ...
      + [Installation et configuration de Document Services](using/install-configure-document-services.md)
   ...
   + Install AEM Forms on JEE {#jee-installation}
      ...
      + [Installation et configuration du serveur Document Security uniquement](using/installing-and-configuring-the-document-security-server.md)
...
+ Gestion d’AEM Forms {#manage-administer-aem-forms}
   ...
   + Handling user data {#handling-user-data}
      ...
      + [Processus Forms JEE](using/forms-workflow-jee-handling-user-data.md)
...
+ Rapports de workflow {#process-reporting}
   + [Présentation des rapports de processus](/help/forms/using/process-reporting/introduction-process-reporting.md)
   + [Prise en main des rapports de processus](/help/forms/using/process-reporting/install-start-process-reporting.md)
   ...
   + [Rapports personnalisés dans les rapports de processus](/help/forms/using/process-reporting/process-reporting-custom-reports.md)
   + [Requêtes ad hoc dans les rapports de processus](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md)
   + [Résolution des problèmes de création de rapports de processus](/help/forms/using/process-reporting/troubleshooting-process-management.md)
+ Guides de référence pour les développeurs {#developer-reference}
   ...
   + Programmation avec AEM Forms sur JEE {#programming-aem-forms-jee}
      ...
      + Java API Quick Start - Exemples de code {#java-api-quick-start-code-examples}
         ...
         + [Service de sauvegarde et de restauration : démarrage d’APIQuick](developing/backup-restore-service-api-quick.md)
         ...
         + [Démarrage rapide de l’API Java du service Document Management (obsolète) (SOAP)](developing/document-management-service-deprecated-java.md)
         + [Démarrage rapide de l’API Java du service de sécurité des documents (SOAP)](developing/document-security-service-java-api.md)
         ...
         + [Démarrage rapide de l’API du service Forms](developing/forms-service-api-quick-starts.md)
         ...
         + [API Java du service Task Manager QuickStart (SOAP)](developing/task-manager-service-java-api.md)
      ...
      + Exécution d’opérations de service à l’aide d’API {#performing-service-operations-using-apis}
         ...
         + [Désassemblage programmatique de documents PDF](developing/programmatically-disassembling-pdf-documents.md)
         ...
         + [Création d&#39;applications Web qui renvoient des formulaires](developing/creating-web-applications-renders-forms.md)
         ...
         + [Détermination De La Conformité Des Documents À La Norme PDF/A](developing/determining-whether-documents-pdf-a.md)
