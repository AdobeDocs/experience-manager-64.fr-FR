...
1. Inclure les fichiers de projet
   ...
   * Créez un assembly client Microsoft .NET qui consomme le service WSDL de formulaires à code à barres. Pour plus d’informations, voir [Appel d’AEM Forms à l’aide du codage](/help/forms/developing/invoking-aem-forms-using-web.md#invoking-aem-forms-using-base64-encoding)Base64.
