...
L’exemple de code suivant convertit un fichier PostScript nommé *Loan.ps *en fichier PDF intitulé *Loan.pdf*. (Voir [Conversion de documents PostScript en  PDF](/help/forms/developing/converting-postscript-pdf-documents.md#converting-postscript-to-pdf-documents).)
