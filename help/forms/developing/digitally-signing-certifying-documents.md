...
* Validez toutes les signatures numériques situées dans un document PDF. (See [Verifying Multiple Digital Signatures](#unresolvedlink-lc-si).)
...
>[!NOTE]
>
>Certains types de document PDF ne permettent pas d’ajouter par programmation un champ de signature. Pour plus d’informations sur le service Signature et l’ajout de champs de signature, voir Référence [des services pour AEM Forms](https://www.adobe.com/go/learn_aemforms_services_63).
...
Effectuez une itération sur chaque signature. Ainsi, pour chaque signature, vérifiez la signature numérique et l’identité du signataire et l’état de chaque signature. (voir [Vérification des signatures](#unresolvedlink-lc-si)numériques).
