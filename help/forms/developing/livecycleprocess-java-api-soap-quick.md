...
Le démarrage rapide de l’API Java (SOAP) est disponible pour les processus. Une instance *de* processus est une occurrence d’un processus spécifique qui a été démarré par une méthode d’appel telle que l’API d’appel ou à partir de Workspace.
...
L’exemple de code Java suivant montre comment démarrer une instance de processus suspendue.
