...
Une fois le fichier .apk généré, exécutez la commande suivante pour installer l’application sur un appareil Android à l’aide de [Android Debug Bridge](https://developer.android.com/tools/help/adb.html).
