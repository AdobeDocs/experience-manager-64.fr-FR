---
title: Installation et configuration du flux de travail centré sur Forms sur OSGi
seo-title: Installation et configuration du flux de travail centré sur Forms sur OSGi
...
# Installation et configuration du flux de travail centré sur Forms sur OSGi {#installing-and-configuring-forms-centric-workflow-on-osgi}

## Présentation {#introduction}

Les entreprises collectent et traitent les données de plusieurs formulaires, systèmes principaux et autres sources de données. Le traitement des données implique des procédures de révision et d’approbation, des tâches répétitives et l’archivage des données. Par exemple, la révision d’un formulaire et sa conversion en document PDF. Lorsqu’elles sont effectuées manuellement, les tâches répétitives peuvent prendre beaucoup de temps et de ressources.

Vous pouvez utiliser le flux de travail centré sur [Forms sur OSGi](/help/forms/using/aem-forms-workflow.md) pour créer rapidement des flux de travail basés sur des formulaires adaptatifs. Ces processus peuvent vous aider à automatiser les processus de révision et d’approbation, les processus d’entreprise et d’autres tâches répétitives. Ces processus permettent également de traiter des documents (créer, assembler, distribuer et archiver des documents PDF, ajouter des signatures numériques pour limiter l’accès aux documents, décoder des formulaires à code à barres, etc.) et utiliser le processus de signature Adobe Sign avec des formulaires et des documents.
...
AEM Forms est une plate-forme d’entreprise performante. Le flux de travail centré sur les formulaires sur OSGi n’est qu’une des fonctionnalités d’AEM Forms. Pour obtenir la liste complète des fonctionnalités, voir [Présentation d’AEM Forms](/help/forms/using/introduction-aem-forms.md).

>[!NOTE]
>
>Avec le processus basé sur l’utilisation de Forms sur OSGi, vous pouvez rapidement créer et déployer des processus pour différentes tâches sur la pile OSGi, sans avoir à installer la fonctionnalité Process Management complète sur la pile JEE. Consultez une [comparaison](/help/forms/using/capabilities-osgi-jee-workflows.md) des processus AEM orientés Forms sur OSGi et Process Management sur JEE pour découvrir les différences et les similitudes des fonctionnalités.
>
...
Le package du module complémentaire AEM Forms est une application déployée sur AEM. Vous avez besoin d’un minimum d’une instance d’auteur ou de traitement AEM (auteur de production) pour exécuter le flux de travail orienté vers Forms sur la fonctionnalité OSGi. A processing instance is a [hardened AEM Author](/help/forms/using/hardening-securing-aem-forms-environment.md) instance. N’effectuez aucune création réelle, comme la création de processus ou de formulaires adaptatifs, sur l’auteur de la production.
...
>[!NOTE]
>
>Passez à la section Etapes [](#next-steps) suivantes du document, si vous avez déjà installé AEM Forms sur OSGi, comme expliqué dans l’article [Installer et configurer les fonctionnalités](/help/forms/using/installing-configuring-aem-forms-osgi.md) de capture de données.
...
Vous avez configuré un environnement pour utiliser le flux de travail centré sur Forms sur les fonctionnalités OSGi. Les étapes nécessaires pour utiliser cette fonctionnalité sont les suivantes :

* [Utilisation du flux de travaux Forms sur OSGi](/help/forms/using/aem-forms-workflow.md)
