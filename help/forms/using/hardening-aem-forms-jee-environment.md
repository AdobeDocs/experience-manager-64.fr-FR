...
Vous ne devez pas installer ni configurer AEM Forms on JEE à l’aide d’un shell racine. Par défaut, les fichiers sont installés sous le répertoire /opt et l’utilisateur qui effectue l’installation a besoin de toutes les autorisations de fichier sous /opt. Une installation peut également être effectuée sous le répertoire /user d’un utilisateur spécifique, où il dispose déjà de toutes les autorisations de fichier.
...
1. Attribuez au nouveau compte utilisateur les autorisations de lecture et d’exécution, de lecture du contenu des dossiers et de lecture pour les répertoires de contenu web d’AEM Forms on JEE.
...
1. Attribuez au nouveau compte utilisateur les autorisations de lecture et d’exécution, de lecture et de contenu des dossiers, ainsi que les autorisations de lecture pour les répertoires de contenu Web d’AEM Forms on JEE.
