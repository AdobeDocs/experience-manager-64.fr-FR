...
AEM Forms est une plateforme d’entreprise performante. La communication interactive n’est qu’une des fonctionnalités d’AEM Forms. Pour obtenir la liste complète des fonctionnalités, voir [Présentation d’AEM Forms](/help/forms/using/introduction-aem-forms.md).
...
Le package de compatibilité AEMFD vous permet d’utiliser les ressources suivantes d’AEM 6.3 Forms et d’AEM 6.2 Forms sur Forms 6.4 :
