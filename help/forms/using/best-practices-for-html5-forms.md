...
* Activez la compression web. Cela réduit la taille des requêtes et des réponses issues d’un formulaire. Pour plus d’informations, voir [Réglage des performances du serveur AEM Forms](https://helpx.adobe.com/aem-forms/6-3/performance-tuning-aem-forms.html).
...
* [Meilleures pratiques pour l’utilisation des formulaires adaptatifs](/help/forms/using/adaptive-forms-best-practices.md)
