...
Pour plus d’informations sur les rapports prédéfinis, voir Rapports [prédéfinis dans le Rapports](pre-defined-reports-in-process-reporting.md)de processus.
...
Pour plus d’informations sur les requêtes ad hoc, voir Requêtes [ad hoc dans le Rapports](adhoc-queries-in-process-reporting.md)de processus.
