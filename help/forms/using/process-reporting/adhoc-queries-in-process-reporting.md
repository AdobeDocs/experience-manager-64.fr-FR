...
1. Exécutez une recherche de processus/tâche. Pour plus d’informations, consultez la section [Pour exécuter une requête de processus](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p).
