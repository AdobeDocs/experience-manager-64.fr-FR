...
1. Utilisez les options situées dans le coin supérieur droit du panneau **Rapport** pour effectuer des opérations sur le résultat  du.
...
1. Exécutez une recherche de processus/de. Pour plus d’informations, voir [Exécution d’un](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p)de recherche de processus.
