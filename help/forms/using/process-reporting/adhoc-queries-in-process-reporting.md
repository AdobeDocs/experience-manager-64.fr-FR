...
1. Exécutez une recherche de processus/tâche. Pour plus d&#39;informations, voir [Pour exécuter une requête de recherche de processus](/help/forms/using/process-reporting/adhoc-queries-in-process-reporting.md#p-to-execute-a-search-query-p).
