...
## Exemple de présentation {#sample-overview}
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>Nombre maximal de connexions Principales</td> 
   <td>1 000</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td>Connexions inactives min.</td> 
   <td>10</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>Les exemples de valeurs sont SELECT 1(mysql), select 1 from double(oracle), SELECT 1 (MS Sql Server) (validationQuery).</td> 
  </tr> 
  <tr> 
   <td>Délai de requête de validation</td> 
   <td>10 000</td> 
  </tr> 
 </tbody> 
</table>
...
1. Si vous disposez déjà des tables (données, métadonnées et métadonnées supplémentaires) dans le schéma de base de données, exécutez les modifications de requêtes de table suivantes :
