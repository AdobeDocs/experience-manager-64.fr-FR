...
AEM Forms on JEE offre la possibilité d’utiliser un formulaire adaptatif dans Workspace HTML.
...
1. Sélectionnez le formulaire adaptatif créé via l’interface utilisateur de gestion des actifs, puis cliquez sur **[!UICONTROL OK]**.
   ...
   >
   >Pour plus d’informations sur la création d’un processus, voir [Création et gestion des processus](https://help.adobe.com/en_US/AEMForms/6.1/WorkbenchHelp/WS92d06802c76abadb-1cc35bda128261a20dd-7ff7.2.html).
