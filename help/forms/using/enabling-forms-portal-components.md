...
1. Pour les pages utilisant un modèle dynamique, procédez comme suit :
   ...
   1. Appuyez sur **Layout Container** et appuyez sur ![FeedManagement](assets/FeedManagement.png). Dans l’onglet **Composants autorisés**, activez les options **Services de document et Prédicats de services de document**, puis appuyez sur ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
