...
1. Pour les pages utilisant un modèle dynamique, procédez comme suit :
   ...
   1. Appuyez sur Conteneur **de mise en page** et appuyez sur ![Gestion](assets/FeedManagement.png)des flux. Dans l’onglet Composants **** autorisés, activez les options **Document Services et Prédicats** Document Services, puis appuyez sur ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
