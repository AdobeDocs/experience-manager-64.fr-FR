...
1. Pour les pages qui utilisent un modèle dynamique, effectuez les étapes suivantes :
   ...
   1. Appuyez sur Conteneur **de** mise en page et appuyez sur ![Gestion](assets/FeedManagement.png)des flux. In the **Allowed Components** tab, enable the **Document Services and Document Services Predicates** options, and tap ![aem_6_3_forms_save](assets/aem_6_3_forms_save.png).
