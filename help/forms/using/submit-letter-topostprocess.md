...
1. **AEM Workflow :** les workflows AEM peuvent également être utilisés comme post-traitements pour les lettres envoyées. Instructions pour installer [AEM Workflow](/help/forms/using/aem-forms-workflow.md).
...
1. Configurez les paramètres AEM DS. Voir [Configuration des paramètres d’AEM DS](/help/forms/using/configuring-the-processing-server-url-.md).
...
Pour plus d’informations sur l’enregistrement d’un brouillon de lettre, voir [Enregistrement de brouillons et envoi d’instances de lettre](/help/forms/using/create-correspondence.md#savingdrafts).
