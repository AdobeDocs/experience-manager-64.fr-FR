...
* Suivi des tâches qui font partie des processus que vous avez démarrés ou auxquels vous avez participé
...
* Cliquez sur l’onglet Démarrer le processus, Tâches ou Tracking pour accéder aux trois principales zones de travail.
* Sur les onglets Démarrer le processus, Tâches et Suivi, cliquez sur les éléments dans la liste du panneau de gauche pour accéder aux favoris, aux catégories de processus, aux modèles de recherche, aux brouillons ou aux tâches assignées. Utilisez la barre de défilement pour afficher d’autres éléments dans la liste.
...
* Cliquez sur l’icône Toutes les options dans la barre de navigation, au bas de la page, pour transférer la tâche à un autre utilisateur, partager la tâche avec un autre utilisateur, consulter un autre utilisateur sur la tâche ou verrouiller la tâche.
...
* Si vous rencontrez des problèmes lors de la tabulation depuis les barres d’outils situées en haut du navigateur, appuyez sur Ctrl+Tab pour accéder au contenu de la fenêtre du navigateur.
* L’aide de l’espace de travail AEM Forms s’ouvre dans une fenêtre de navigateur distincte. Après avoir consulté l’aide, le focus retourne à la fenêtre du navigateur qui contient l’espace de travail AEM Forms. Le menu Aide reste sélectionné lorsque la sélection revient.
...
**Files d’attente :** définissez des préférences de partage de votre liste Tâches avec d’autres utilisateurs ou de demande d’accès à la liste d’un autre utilisateur. Voir [Utilisation des tâches des files d’attente de groupe et partagées](/help/forms/using/todo-lists.md#working-with-tasks-from-group-and-shared-queues).
...
### Définition des préférences de l’interface utilisateur {#set-user-interface-preferences}
...
* **Format de date :** Indique le format d’affichage des dates utilisé dans l’espace de travail AEM Forms.
...
* **Enregistrer régulièrement le brouillon :** définit si les brouillons de formulaires sont régulièrement enregistrés ou non, et ce de manière automatique. Pour enregistrer vos brouillons régulièrement, activez cette option et définissez la durée d’enregistrement automatique de 1 à 30 minutes. Lorsque l’enregistrement automatique est activé et qu’un utilisateur travaille sur un brouillon, ce dernier est enregistré régulièrement après le nombre de minutes spécifié. Le brouillon n’est enregistré automatiquement que lorsqu’il a été modifié depuis le dernier enregistrement ou l’enregistrement automatique. Lorsque le brouillon est enregistré, un message d’alerte s’affiche à l’écran.
