...
Suivez les [Étapes génériques de personnalisation de l’espace de travail AEM Forms](/help/forms/using/generic-steps-html-workspace-customization.md) et selon vos besoins, suivez les étapes de personnalisation de CSS, HTML ou des deux.
...
**beforeFigure :** *barre de navigation supérieure avant personnalisation de la police*
