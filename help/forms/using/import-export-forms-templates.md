...
Pour télécharger des ressources de formulaires et documents :
...
1. In the Download Asset(s), choose one of the following options, and tap **Download**.
   ...
   * **Télécharger le/les actifs sous forme de fichiers binaires :** utilisez l’option pour télécharger uniquement les modèles de formulaire (XDP), les formulaires PDF (PDF), les documents (PDF) et les ressources (images, schémas, feuilles de style). Vous pouvez modifier ces actifs dans des applications externes. Cette option permet de télécharger les ressources de formulaires qui possèdent des fichiers binaires, telles que des fichiers XSD, XDP, des images, des fichiers PDF et XDP comme un fichier .zip.
      ...
      You cannot download adaptive forms, Interactive Communications, adaptive form fragments, themes, and form sets with **Download asset(s) as binary files** option. Pour télécharger ces actifs, vous devez utiliser l’option **Télécharger sous forme de package CRX**.
...
1. Dans la boîte de dialogue, recherchez et sélectionnez le package ou l’archive à importer. Vous pouvez également sélectionner un document PDF, des fichiers XSD, des images, des feuilles de style et des formulaires XDP. Appuyez sur **Ouvrir**.
...
1. Tap **Export** and, in the confirm message, tap **OK**.
   ...
   À la fin du traitement par lot, les détails de la dernière exécution et un lien de téléchargement du package s’affichent. Cela inclut des informations telles que la connexion administrateur et si le lot est &quot;réussi ou échoué&quot;. Les actifs sont exportés vers un package et le lien Télécharger le package exporté s’affiche.
...
>[!NOTE]
>
>Lors de l’importation d’anciens actifs de Correspondence Management pour la migration, connectez-vous à l’aide d’un compte administrateur. Pour plus d’informations sur la migration des anciens actifs de Correspondence Management, voir [Migration des actifs et des documents](/help/forms/using/migration-utility.md)AEM Forms.

1. On the data dictionary, letters, or document fragments page, tap **Create > File Upload** and select the .cmp file.
1. Correspondance Management affiche la boîte de dialogue d’importation des actifs avec la liste des actifs qui sont importés. Tap **Import**.
...
L’interface utilisateur d’AEM Forms vous permet de rechercher votre contenu. Using the top bar, you can tap Search **A** to search your content for resources such as assets and documents.

Lorsque vous recherchez des actifs, AEM Forms affiche le panneau latéral. You can also tap ![assets-browser-content-only](assets/assets-browser-content-only.png) > Filter **[B]** to invoke the side panel. À l’aide des divers filtres disponibles dans le panneau latéral, vous pouvez affiner votre recherche. Le panneau latéral permet également d’enregistrer vos recherches.

![search_topbar](assets/search_topbar.png)

******A. Recherche** B. Filtrer

![](assets/search_sidepanel.png) Panneau latéral - Filtres **** Figure : Panneau *latéral - Filtres*
