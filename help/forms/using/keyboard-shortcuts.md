...
Cette section répertorie les différents claviers et raccourcis d’accessibilité que vous pouvez utiliser dans l’éditeur de texte de Correspondence Management. Vous pouvez utiliser ces raccourcis lorsque vous :

* Créer ou modifier un actif de [texte](document-fragments.md)
...
<table> 
 <tbody>
  ...
  <tr>
   <td><p>Déplacer le curseur au début du mot suivant</p> </td> 
   <td><p>Ctrl+Flèche Droite</p> </td> 
   <td>Option + Flèche Droite <em><sup>[1]</sup></em></td> 
  </tr>
  <tr>
   <td><p>Déplacer le curseur au début du mot précédent</p> </td> 
   <td><p>Ctrl+Flèche Gauche </p> </td> 
   <td>Option + Flèche Gauche</td> 
  </tr>
  <tr>
   <td><p>Déplacez le curseur vers le paragraphe suivant.</p> </td> 
   <td><p>Ctrl+Flèche Bas</p> </td> 
   <td>Option + Flèche Bas</td> 
  </tr>
  <tr>
   <td><p>Déplacez le curseur vers le paragraphe précédent.</p> </td> 
   <td><p>Ctrl+Flèche Haut</p> </td> 
  ...
  <tr>
   <td><p>Sélectionner le texte jusqu’à la position actuelle de la page</p> </td> 
   <td><p>Maj+Page Haut</p> </td> 
   <td>Fn+Maj+Flèche Haut</td> 
  </tr>
  <tr>
   <td><p>Sélectionner le texte jusqu’à la fin de la position de fin de la page</p> </td> 
  ...
  <tr>
   <td><p>Sélectionner le texte de la position actuelle à la fin (du module)</p> </td> 
   <td><p>Maj+Ctrl+Fin</p> </td> 
   <td>Commande + Maj + Flèche Bas<br /> </td> 
  </tr>
  <tr>
   <td><p>Sélectionner le texte de la position actuelle au début (du module)</p> </td> 
   <td><p>Maj+Ctrl+Accueil</p> </td> 
   <td>Commande + Maj + Flèche Haut</td> 
  </tr>
  <tr>
  ...
  <tr>
   <td><p>Déplacer le curseur à la position de fin</p> </td> 
   <td><p>Ctrl+Fin</p> </td> 
...
### Annulation et rétablissement d’actions {#undo-and-redo-actions}
...
### Supprimer un mot {#deleting-a-word}
...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td><p>Ctrl+V / Maj+Insertion</p> </td> 
   <td>Commande + V</td> 
  </tr>
  <tr>
