...
Le service DocAssurance n’est pas disponible en standard. Pour configurer le service DocAssurance, voir [Configuration de Document Services](/help/forms/using/install-configure-document-services.md).
