...
1. Dans le **[!UICONTROL URL d’auteur VersionRestoreManager]** , spécifiez l’URL de l’instance d’auteur de VersionRestoreManager.
   ...
   **Chaîne d’URL**:
   ...
   >[!NOTE]
   >
   >S’il existe plusieurs instances d’auteur (en grappe) devant un équilibreur de charge, spécifiez l’URL de l’équilibreur de charge dans la variable **[!UICONTROL URL d’auteur VersionRestoreManager]** champ .
