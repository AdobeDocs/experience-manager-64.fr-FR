...
Pour plus d’informations sur la création du processus de flux de travaux AEM Forms JEE, voir [Aide de Workbench](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/pdf/WorkbenchHelp.pdf).
