...
Pour utiliser les ressources fournies pour l’exemple de cet article, téléchargez l’exemple de module, comme expliqué dans la section suivante, voir [Exemple de module](/help/forms/using/synchronizing-adaptive-forms-xfa.md#p-sample-package-p).
