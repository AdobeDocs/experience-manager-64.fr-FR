...
## Création d’un alias pour des informations d’identification HSM lorsque l’appareil HSM est en ligne {#create-an-alias-for-an-hsm-credential-when-the-hsm-device-is-online}
