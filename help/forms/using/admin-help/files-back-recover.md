...
L’emplacement par défaut du répertoire racine de l’Enregistrement de contenu est *[racine aem-forms]*/lccs_data.
...
L’emplacement par défaut du répertoire racine de l’Enregistrement de contenu est *[racine du stockage global de documents]*/lccs_data, où *[racine du stockage global de documents]* correspond à l’emplacement décrit dans [emplacement du stockage global de documents](files-back-recover.md#gds-location). Sauvegardez les répertoires suivants situés dans le répertoire racine de stockage de contenu :
...
L’emplacement par défaut du répertoire racine d’index est *[racine aem-forms]*/lucene-indexes sur chaque noeud.
...
>[!NOTE]
>
>Par défaut, les polices d’Adobe installées avec AEM forms se trouvent dans le répertoire [racine aem-forms]/fonts.
