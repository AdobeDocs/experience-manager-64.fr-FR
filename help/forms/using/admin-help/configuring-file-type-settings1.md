...
1. Fournissez les informations requises dans ces zones :
   ...
   [Paramètres de conversion du HTML en PDF](/help/forms/using/admin-help/configuring-file-type-settings1.md#main-pars-heading-3)
   ...
   [Paramètres de Microsoft Visio (Windows uniquement)](/help/forms/using/admin-help/configuring-file-type-settings1.md#main-pars-header-1354428557)
