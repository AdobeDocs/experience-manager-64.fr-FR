...
**Identifiant de la stratégie :** ID de la stratégie jointe au document.
...
**Extraire le document protégé :** Extrait le document du PDF protégé par une stratégie du document du PDF avec la page de garde
