...
1. Dans Administration Console, cliquez sur **[!UICONTROL Paramètres > Gestion utilisateur > Utilisateurs et groupes]**, puis cliquez sur **[!UICONTROL Nouvel utilisateur]**. .
...
1. (Facultatif) Pour ajouter un utilisateur à un groupe, cliquez sur **[!UICONTROL Recherche de groupes]** et effectuez les tâches suivantes :

   * Dans le **[!UICONTROL Rechercher]** , saisissez une partie ou l’intégralité du nom du groupe.
   * Sélectionnez le domaine à rechercher, sélectionnez le nombre d’éléments à afficher, puis cliquez sur **[!UICONTROL Rechercher]**.
   * (Facultatif) Pour afficher les détails d’un groupe, sélectionnez son nom, puis cliquez sur **[!UICONTROL OK]** pour revenir à la page des résultats de la recherche.
   * Cochez la case correspondant au groupe et cliquez sur **[!UICONTROL OK]**.
   * Cliquez sur **[!UICONTROL Suivant]**.

1. (Facultatif) Pour affecter des rôles à l’utilisateur, cliquez sur **[!UICONTROL Recherche de rôles]**, cochez la case correspondant aux rôles à affecter, puis cliquez sur **[!UICONTROL OK]**.
...
Évitez d’utiliser des caractères de soulignement (_) dans les noms canoniques, par exemple : `sample_user`. Lorsque vous recherchez des utilisateurs à l’aide de leur nom canonique, les noms contenant des caractères de soulignement n’apparaissent pas dans les résultats.
...
1. Dans Administration Console, cliquez sur **[!UICONTROL Paramètres > Gestion utilisateur > Utilisateurs et groupes]**.
1. Spécifiez les informations pour affiner la recherche d’un utilisateur particulier et cliquez sur **[!UICONTROL Rechercher]**. Les résultats de recherche apparaissent au bas de la page. Vous pouvez trier la liste en cliquant sur les en-têtes de colonne.
...
1. Pour rechercher l’utilisateur à modifier, procédez comme suit :
   ...
   * Dans le **[!UICONTROL Rechercher]** saisissez vos critères de recherche.
   * Dans le **[!UICONTROL Utilisation]** list, select **[!UICONTROL Nom]**, **[!UICONTROL Email]** ou **[!UICONTROL Identifiant utilisateur]**.
   * Dans le **[!UICONTROL Dans la liste]**, sélectionnez **[!UICONTROL Utilisateurs]**.
...
1. Pour un utilisateur faisant partie d’un domaine local ou hybride, sur la variable **[!UICONTROL Détail]** , modifiez la variable **[!UICONTROL Paramètres généraux]** et **[!UICONTROL Paramètres de connexion]**, puis cliquez sur **[!UICONTROL Enregistrer]**. Pour plus d’informations sur ces paramètres, voir [Paramètres utilisateur](adding-configuring-users.md#user-settings). Vous n’avez pas la possibilité de modifier les paramètres généraux ni les paramètres de connexion d’un utilisateur appartenant à un domaine d’entreprise.
1. Pour modifier les paramètres du groupe de l’utilisateur, cliquez sur le bouton **[!UICONTROL Appartenance à un groupe]** et procédez comme suit :

   * Cliquez sur **[!UICONTROL Rechercher un groupe]** et renseignez les informations de la recherche.
   * Pour ajouter l’utilisateur à un nouveau groupe, cochez la case correspondant au groupe, puis cliquez sur **[!UICONTROL OK]**, puis cliquez sur **[!UICONTROL Enregistrer]**.
   ...
   * Pour retirer l’utilisateur d’un groupe, cochez la case correspondant au groupe, puis cliquez sur **[!UICONTROL Supprimer]**, puis cliquez sur **[!UICONTROL Enregistrer]**.


1. Pour modifier les rôles de l’utilisateur, cliquez sur le bouton **[!UICONTROL Affectations de rôles]** et procédez comme suit :

   * Pour afficher une liste des rôles, cliquez sur **[!UICONTROL Recherche de rôles]**.
   * Pour ajouter un rôle, cochez la case correspondante, puis cliquez sur **[!UICONTROL OK]**, puis cliquez sur **[!UICONTROL Enregistrer]**.
   * Pour supprimer un rôle, cochez la case correspondant, puis cliquez sur **[!UICONTROL Annuler]**, puis cliquez sur **[!UICONTROL Enregistrer]**.
...
1. Cochez la case correspondant à l’utilisateur, puis cliquez sur **[!UICONTROL Supprimer]**, puis cliquez sur **[!UICONTROL OK]**.
