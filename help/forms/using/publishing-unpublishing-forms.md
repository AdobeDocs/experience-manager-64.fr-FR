...
AEM Forms permet de planifier la publication et l’annulation de publication des éléments de formulaires et documents. Vous pouvez spécifier la planification dans l’éditeur de métadonnées. For more information about managing form metadata, see [Managing form metadata.](/help/forms/using/manage-form-metadata.md)
