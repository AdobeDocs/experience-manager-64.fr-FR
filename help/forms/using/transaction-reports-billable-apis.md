...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td>L’API vous permet de protéger votre document. Vous pouvez utiliser l’API pour signer, certifier, Reader, étendre ou chiffrer un document PDF. </td> 
   <td>Documents traités</td> 
