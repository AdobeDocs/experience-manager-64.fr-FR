...
Certains services de serveur de formulaires permettent un appel non authentifié (anonyme) pour certaines opérations. Cela signifie qu’une ou plusieurs opérations exposées par le service peuvent être appelées en tant qu’utilisateur authentifié ou en tant qu’aucun utilisateur authentifié.
