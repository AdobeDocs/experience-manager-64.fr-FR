...
* La structure fournit un ensemble d’options pour l’aspect d’un champ. Ces options sont des paires clé-valeur et divisées en deux catégories : options courantes et options spécifiques au type de champ.
