...
1. Appuyez sur **Créer** > **Texte.** Vous pouvez également sélectionner une ressource de texte et appuyer sur  **Modifier**.
...
1. Appuyez sur **Suivant**. Correspondence Management affiche la page Éditeur dans laquelle vous pouvez ajouter des paragraphes et des éléments de données de texte au texte.
   ...
   Vous pouvez également utiliser les différents raccourcis clavier de l’éditeur de texte pour gérer, modifier et mettre en forme le texte. Pour plus d’informations sur les raccourcis clavier [Éditeur de texte](/help/forms/using/keyboard-shortcuts.md#p-formatting-p) dans les raccourcis clavier de Correspondence Management.
...
1. Un éditeur de texte s’ouvre. Entrez le texte. Utilisez la barre d’outils située en haut de la page pour mettre en forme le texte, les conditions d’insertion, le lien et les sauts de page.
   ...
   * **Lien** : Insérez un lien hypertexte dans le texte. Appuyez sur **[!UICONTROL Lien]**, spécifiez le lien dans le champ **[!UICONTROL URL]**, supprimez le nom d’objet par défaut du champ **[!UICONTROL Texte de remplacement]** et appuyez sur ![Enregistrer](assets/save_icon.svg).
...
1. Si nécessaire, insérez des caractères spéciaux dans le fragment de document. Vous pouvez, par exemple, utiliser la palette des caractères spéciaux pour insérer les caractères suivants :
   ...
   * Symboles de ponctuation tels que ‟ et&quot;
   ...
   Correspondence Management offre une prise en charge intégrée de 210 caractères spéciaux. L’administrateur peut [ajouter la prise en charge de caractères spéciaux plus ou personnalisés en personnalisant](/help/forms/using/custom-special-characters.md).
...
1. Dans le volet de données, faites glisser des éléments du dictionnaire de données et des éléments d’espace réservé dans le texte.
   ...
   **Figure :** *Valeurs d’élément d’espace réservé dans la vue CCR renseignée à partir des variables du dictionnaire de données comme spécifié dans l’exemple de fichier de données*
...
1. Appuyez sur **Ajouter la ressource**.
...
1. Appuyez sur **Suivant**.
1. Appuyez sur **Ajouter la ressource**.
1. Pour ajouter une ressource à la condition, sélectionnez-la sur la page Sélectionner les ressources et appuyez sur **Terminé**. Les actifs sont ajoutés au volet Expression.
...
1. Appuyez sur **Copier** pour dupliquer une ligne.
1. Appuyez sur **Edit** (Modifier) pour modifier l’actif ou l’expression.

   Par ailleurs :

   * Pour mettre à jour l’actif, appuyez sur l’icône de dossier dans la colonne Actif.
   * Pour ouvrir le Générateur d’expression afin d’insérer une expression, appuyez sur l’icône de dossier dans la colonne Expression. Pour plus d’informations sur le Générateur d’expression, voir [Générateur d’expression](/help/forms/using/expression-builder.md).
