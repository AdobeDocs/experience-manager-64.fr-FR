...
1. Accédez à l’onglet **Ressources** et appliquez le filtre pour afficher uniquement les fragments de document dans le volet de gauche.
...
1. Appuyez sur le composant Graphique et sélectionnez ![configure_icon](assets/configure_icon.png) (Configurer). Les propriétés du graphique s’affichent dans le volet gauche :
   ...
   1. Sélectionnez la propriété **calltype** à partir du type d’objet de modèle de données **calls** dans la section **Axe Y** . Appuyez sur ![done_icon](assets/done_icon.png).
   1. Appuyez sur ![done_icon](assets/done_icon.png) pour enregistrer les propriétés du graphique.

1. Accédez à l’onglet **Ressources** et appliquez le filtre pour afficher uniquement les fragments de mise en page dans le volet de gauche. Faites glisser le fragment de mise en page **table_lf** dans la zone cible **Appels détaillés**.
...
1. Appuyez sur **PayNow** zone cible, puis sur **+** pour ajouter un composant **Image**.
...
1. Appuyez sur **Modifier** pour ouvrir la communication interactive dans le volet droit.
1. Appuyez sur l’onglet **Canaux** dans le volet de gauche, puis appuyez sur **Web**.
1. Accédez à l’onglet **Ressources** et appliquez le filtre pour afficher uniquement les fragments de document dans le volet de gauche.
1. Faites glisser les fragments de documents suivants vers leurs zones cibles dans la communication interactive :
...
1. Appuyez sur **Résumé des frais** et appuyez sur **+** pour ajouter un composant **Graphique**.
1. Appuyez sur le composant Graphique et sélectionnez ![configure_icon](assets/configure_icon.png) (Configurer). Les propriétés du graphique s’affichent dans le volet gauche :
...
1. Sélectionnez **En-tête de colonne du tableau Mobilenum** et sélectionnez **Autres options** > **Supprimer la colonne**. De même, supprimez la colonne **calltype**.
1. Sélectionnez l’en-tête de colonne du tableau **Calldate** et appuyez sur ![edit](assets/edit.png) (Modifier) pour renommer le texte en **Date de l’appel**. De même, renommez les autres en-têtes des colonnes du tableau.
1. Selon le cas d’utilisation, insérez un bouton **Payer maintenant** dans la communication interactive qui permet à l’utilisateur d’effectuer le paiement en cliquant sur le bouton. Effectuez les étapes suivantes pour insérer le bouton :
   ...
   1. Appuyez sur **Payer maintenant** et appuyez sur **+** pour ajouter un composant **Texte**.
   1. Appuyez sur le composant de texte et appuyez sur ![edit](assets/edit.png) (Modifier).
...
1. Appuyez sur **Payer maintenant** et appuyez sur **+** pour ajouter un composant **Image**.
1. Appuyez sur le composant Image et sélectionnez ![configure_icon](assets/configure_icon.png) (Configurer). Les propriétés de l’image s’affichent dans le volet gauche :
...
1. Selon le cas d’utilisation, insérez un bouton **S’abonner** dans la communication interactive qui permet à l’utilisateur de s’abonner aux services à valeur ajoutée en cliquant sur le bouton .
   ...
   Répétez les étapes 13 à 17 pour ajouter un bouton **S’abonner** à la zone cible **Services à valeur ajoutée** et ajoutez l’image **ValueAddedServicesWeb**.
...
1. Comme la case **Utiliser l’impression comme Principal pour le canal web** est cochée à l’étape 4, le contenu et les liaisons sont générés automatiquement pour le canal web à partir du canal d’impression.
   ...
   Pointez sur la zone cible appropriée du canal web et sélectionnez ![annuler l’héritage](assets/cancelinheritance.png) (Annuler l’héritage), puis, dans la boîte de dialogue **Annuler l’héritage**, appuyez sur **Oui**.

   ![cancel_inheritance_web_channel](assets/cancel_inheritance_web_channel.png)

   Si vous avez annulé l’héritage d’un composant, vous pouvez le réactiver. Pour réactiver l’héritage, passez la souris sur la limite de la zone cible appropriée, qui inclut le composant, et appuyez sur ![réactiver l’héritage](assets/reenableinheritance.png).
