...
1. Ajoutez la variable **[!UICONTROL sun.util.calendar]** vers le module **[!UICONTROL liste autorisée]** champ . Cliquez sur **[!UICONTROL Enregistrer]**.
