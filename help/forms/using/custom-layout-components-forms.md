...
Connaissance des mises en page qui vous permet de créer/utiliser une mise en page personnalisée. Voir [Modification de la disposition du panneau](/help/forms/using/layout-capabilities-adaptive-forms.md).
