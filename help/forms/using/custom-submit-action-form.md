...
>[!NOTE]
>
>Un auteur fournit l’URL de redirection (à l’aide de la configuration de la page Merci). [Les ](/help/forms/using/configuring-submit-actions.md) actions Envoyer prêtes à l&#39;emploi utilisent l&#39;URL de redirection pour rediriger le navigateur à partir de la ressource référencée par le chemin de transfert.
>
