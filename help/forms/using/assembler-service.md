...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>relative</td> 
   <td>Incorpore toutes les images référencées par le biais de références relatives dans le XDP source.<br /> document.</td> 
  </tr> 
  <tr> 
   <td>absolu</td> 
