...
L’intégration d’Acrobat Sign avec AEM Forms prend en charge :
...
### Modifier les propriétés d’un formulaire adaptatif pour Acrobat Sign {#enableadobesign}
