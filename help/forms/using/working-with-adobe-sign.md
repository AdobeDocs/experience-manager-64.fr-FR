...
1. [Modification des propriétés d’un formulaire adaptatif pour la signature Adobe](/help/forms/using/working-with-adobe-sign.md#main-pars-header-46741052)
1. [Ajouter des champs Adobe Sign à un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header-868561487)
1. [Activer Adobe Sign pour un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
1. [Sélectionner un service cloud Adobe Sign pour un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)

1. [Ajouter des signataires Adobe Sign à un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
1. [Sélectionner Envoyer l’action pour un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. Appuyez sur **[!UICONTROL Créer.]** Un formulaire adaptatif activé pour la signature est créé, qui peut être utilisé pour ajouter des champs Adobe Sign.

#### Modification d’un formulaire adaptatif pour Adobe Sign {#editafsign}

Pour utiliser Adobe Sign dans un formulaire adaptatif existant, procédez comme suit :

1. Accédez à **[!UICONTROL Adobe Experience Manager]** > **[!UICONTROL Forms]**> **[!UICONTROL Formulaires et documents]**.
1. Select the adaptive form and tap **[!UICONTROL Properties]**.
1. Dans l’onglet **[!UICONTROL Simple]** , sélectionnez le conteneur [de](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) configuration créé lors de la configuration d’Adobe Sign avec AEM Forms.
1. Dans l’onglet **Mode[!UICONTROL de]formulaire**l, sélectionnez l’une des options suivantes :

   * Sélectionnez le modèle de formulaire **[!UICONTROL Associer comme modèle]** de document d’enregistrement et sélectionnez un modèle de document d’enregistrement. Si vous utilisez un formulaire adaptatif basé sur un modèle de formulaire, les documents envoyés pour signature affichent uniquement les champs basés sur le modèle de formulaire associé. Il n’affiche pas tous les champs du formulaire adaptatif.
   * Sélectionnez l’option **[!UICONTROL Générer le document d’enregistrement]** . Si vous utilisez une option Document d’enregistrement activée pour le formulaire adaptatif, le document envoyé pour signature affiche tous les champs du formulaire adaptatif.

1. Tap **[!UICONTROL Save &amp; Close]**. Le formulaire adaptatif est activé pour Adobe Sign.
...
1. Faites glisser et déposez le composant **Bloc Adobe Sign** de l’explorateur de composants dans le formulaire adaptatif. Le composant Bloc Adobe Sign dispose de tous les champs Adobe Sign pris en charge. Par défaut, il ajoute un champ **Signature **au formulaire adaptatif.
   ...
   >[!NOTE]
   >
   >* L’utilisation du bloc Adobe Sign n’est pas obligatoire pour utiliser Adobe Sign dans un formulaire adaptatif. Si vous n’utilisez pas le bloc Adobe Sign et ajoutez des champs aux signataires, le champ de signature par défaut s’affiche au bas des documents de signature.
...
1. Select the **Adobe Sign Block** component and tap the **Edit** ![aem_6_3_edit](assets/aem_6_3_edit.png) icon. Il affiche des options pour ajouter des champs et mettre en forme l’apparence d’un champ.
   ...
   **** A. Sélectionnez et ajoutez des champs Adobe Sign. **** B. Agrandissement du bloc Adobe Sign en mode Plein écran
...
1. [Ajoutez des signataires à un formulaire](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451) adaptatif et appuyez sur l’icône Terminé pour enregistrer les modifications.
...
1. Appuyez sur l’icône **Adobe Sign Field** ![aem_6_3_adobésité](assets/aem_6_3_adobesign.png) . Il affiche des options permettant de sélectionner et d’ajouter des champs Adobe Sign.
   ...
   * Signatures cloud : Signez à l’aide d’un ID [](https://helpx.adobe.com/sign/kb/digital-certificate-providers.html) numérique hébergé par un fournisseur de services de certification.
   * Adobe Acrobat ou Reader : Téléchargez et ouvrez le document avec Adobe Acrobat ou Reader pour le signer à l’aide d’une carte à puce, d’un jeton USB ou d’un ID numérique basé sur un fichier.
   Après avoir ajouté le champ de signature du cloud au formulaire adaptatif, procédez comme suit pour terminer le processus de configuration :

   * [Activer Adobe Sign pour un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828)
   * [Sélectionner un service cloud Adobe Sign pour un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029)
   * [Ajouter des signataires Adobe Sign à un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1374317451)
   * [Sélectionner Envoyer l’action pour un formulaire adaptatif](/help/forms/using/working-with-adobe-sign.md#main-pars-header)
...
1. Ajoutez et configurez le composant [Étape de signature](/help/forms/using/working-with-adobe-sign.md#main-pars-header-1414119828).
1. Ajoutez le composant [Étape de résumé](/help/forms/using/working-with-adobe-sign.md#main-pars-header-473098029).
...
1. Select the newly added Signature step component and tap the **Configure** ![configure](assets/configure.png) icon. Elle ouvre l’explorateur de propriétés et affiche les propriétés Étape de signature. Configurez les propriétés suivantes :
   ...
   * **Configuration **: sélectionnez une configuration (service cloud Adobe Sign). La liste déroulante n’est disponible que si l’option **Utiliser le composant de signature électronique** est activée.
   ...
   >[!NOTE]
   >
   >* Lorsque vous faites glisser le composant **[!UICONTROL Étape de signature]** dans le formulaire, l’option **[!UICONTROL Le signataire et la personne remplissant le formulaire ne sont-ils qu’une seule et même personne ?]** est automatiquement définie sur **Oui**. Vous devez conserver le formulaire en état de fonctionnement.
