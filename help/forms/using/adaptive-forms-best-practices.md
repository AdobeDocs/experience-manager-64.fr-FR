...
Pour plus d’informations, voir [Automatiser le test des formulaires adaptatifs](/help/forms/using/calvin.md).
...
* Créer [pages d’erreur personnalisées affichées par le gestionnaire d’erreur](https://helpx.adobe.com/experience-manager/6-2/sites-developing/customizing-errorhandler-pages.html).
