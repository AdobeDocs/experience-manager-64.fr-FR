...
Lors de l’installation de l’AEM sur une instance Amazon Elastic Compute Cloud (EC2), si vous installez à la fois l’auteur et la publication sur l’instance EC2, l’instance d’auteur est correctement installée en suivant la procédure d’installation [d’une instance d’AEM](/help/sites-deploying/custom-standalone-install.md) ; toutefois, l’instance de publication devient Auteur.
