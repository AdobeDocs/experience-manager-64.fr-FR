...
>[!NOTE]
>
>Dans AEM 6.4, [oak-run.jar est la méthode UNIQUEMENT prise en charge](/help/sites-deploying/indexing-via-the-oak-run-jar.md#reindexingapproachdecisiontree) pour la réindexation sur les référentiels MongoMK ou RDBMK.
