...
Par exemple, si une instance a été lancée avec les modes d’exécution `author,dev,emea`, et que les deux `/apps/*/config.author/` et `/apps/*/config.emea.author/` définissent une configuration pour\
