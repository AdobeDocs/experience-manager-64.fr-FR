...
* Créez une sauvegarde du ou des utilisateurs à l’origine du problème. Vous pouvez le faire via Package Manager. Pour plus d’informations, voir [Comment utiliser des packages](/help/sites-administering/package-manager.md).
