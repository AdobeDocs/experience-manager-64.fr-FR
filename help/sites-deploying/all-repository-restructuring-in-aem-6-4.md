...
* [Point d’entrée Javascript Adobe DTM](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#adobe-dtm-javascript-endpoint)
* [Point d’entrée Web-Hook Adobe DTM](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#adobe-dtm-web-hook-endpoint)
...
* [Configurations du gadget de tableau de bord Projets AEM](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#aem-projects-dashboard-gadget-configurations)
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>Toute référence de chemin explicite dans
     le code <code>
     custom
    </code> vers l’emplacement précédent doit également prendre en compte le nouvel emplacement. Il est recommandé de restructurer ce code pour utiliser les API de workflow AEM.</td> 
  </tr>
 </tbody>
</table>
