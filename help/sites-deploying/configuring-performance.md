...
**Remarque :**  La configuration de ces files d’attente de tâches affecte tous les workflows, sauf si vous avez créé une file d’attente de tâches pour un modèle de workflow spécifique (voir  [Configuration de la file d’attente pour un ](/help/sites-deploying/configuring-performance.md#configure-the-queue-for-a-specific-workflow) modèle de workflow spécifique ci-dessous).
