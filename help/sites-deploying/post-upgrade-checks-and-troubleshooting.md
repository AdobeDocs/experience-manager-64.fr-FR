...
* [Vérifiez les journaux pour la réussite de la mise à niveau](#verify-logs-for-upgrade-success)
...
Une fois que l’environnement de publication a été entièrement mis à niveau et validé, activez les agents de réplication dans l’environnement de création. Vérifiez que les agents peuvent se connecter aux instances de publication respectives. See [Upgrade Procedure](/help/sites-deploying/upgrade-procedure.md) for more details on order of events.
