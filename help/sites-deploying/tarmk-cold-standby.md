...
1. Arrêtez le processus de synchronisation sur l’instance Secondaire froide en accédant à la console JMX et en utilisant la fonction **org.apache.jackrabbit.oak: État (&quot;Secondaire&quot;)** bean. Pour plus d’informations sur la procédure à suivre, reportez-vous à la section sur [Surveillance](#monitoring).
