...
>[!NOTE]
>
>Cette page décrit la procédure de mise à niveau pour AEM 6.4. Si une installation est déployée sur un serveur d’application, reportez-vous à la section [Procédure de mise à niveau pour les installations du serveur d’application](/help/sites-deploying/app-server-upgrade.md).
...
1. Téléchargez la dernière version du connecteur S3 1.8.x de [https://repo.adobe.com/nexus/content/groups/public/com/adobe/granite/com.adobe.granite.oak.s3connector/](https://repo.adobe.com/nexus/content/groups/public/com/adobe/granite/com.adobe.granite.oak.s3connector/)
