...
audience: end-user
user-guide-title: Notes de mise à jour d’AEM 6.4
...
# Notes de mise à jour d’AEM 6.4 {#release-notes}
...
+ [Programme d’installation des correctifs AEM Forms JEE](jee-patch-installer-64.md)
