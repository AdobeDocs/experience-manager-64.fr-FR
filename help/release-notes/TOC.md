...
audience: end-user
user-guide-title: Notes de mise à jour d’Adobe Experience Manager 6.4
...
# Notes de mise à jour d’Adobe Experience Manager 6.4 {#release-notes}
...
+ [Programme d’installation des correctifs d’AEM Forms JEE](jee-patch-installer-64.md)
...
+ [Notes de mise à jour de Livefyre Feature Pack 2.0.6](livefyre-feature-pack-206.md)