...
Voir aussi [Intégration de l&#39;AEM 3D avec Autodesk Maya](/help/assets/integrate-maya-with-3d.md) et [Intégration de l&#39;AEM 3D avec Autodesk 3ds Max](/help/assets/integrating-aem-3d-with-autodesk-3ds-max.md).

## Formats de fichiers 3D pris en charge {#supported-d-file-formats}

| Format | Description | Plateformes | Notes |
|--- |--- |--- |--- |
