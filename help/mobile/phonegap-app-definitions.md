...
seo-title: Définitions des applications
...
seo-description: 'Consultez cette page pour en savoir plus sur les définitions d’application, qui permettent d’identifier les espaces et autres configurations appropriés à l’application. Les définitions d’application permettent à l’utilisateur d’ajouter de l’espace, sans avoir à recompiler l’application. '
...
# Définitions de l’application{#app-definitions}
...
1. Sélectionnez **Applications** dans **Mobile** et cliquez sur **Créer.**
   ...
   Sélectionnez **Application** et saisissez les détails pour créer votre nouvelle application.
