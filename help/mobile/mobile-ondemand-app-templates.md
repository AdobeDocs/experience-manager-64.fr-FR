...
>[!NOTE]
>
>Pour gérer le contenu de votre application et de votre application mobile depuis AEM Mobile Apps Control Center, consultez le Tableau de bord [de l’application](/help/mobile/mobile-apps-ondemand-application-dashboard.md)AEM Mobile.
...
1. Cliquez sur **Suivant** pour entrer une image d’article ou une image de réseau social.
...
1. Cliquez sur **Créer** pour terminer le processus de création d’un article à l’aide de l’exemple. Pour modifier les propriétés de cet article, cliquez sur **Terminé** ou sur **Modifier l’article** .

![chlimage_1-71](assets/chlimage_1-71.png)

### Ajouter des composants à l’article {#adding-components-to-article}
...
Il n’existe pas de modèles d’article prêts à l’emploi. Cependant, il existe un modèle par défaut que les modèles personnalisés doivent étendre, voir l’exemple [de modèle d’](http://localhost:4502/crx/de/index.jsp#/apps/geometrixx-unlimited-app/templates/article)article de l’application Geometrixx Unlimited.
...
>[!NOTE]
>
>Vous pouvez créer un composant dans AEM et en personnaliser un à l’aide de l’option [Développer avec CRXDE Lite](/help/sites-developing/developing-with-crxde-lite.md). Une fois que vous avez personnalisé le composant existant en fonction de vos besoins, vous pouvez l’ajouter dans votre page à l’aide de l’option **Modifier** sous **Gérer les articles** , comme illustré dans la figure ci-dessus.

>[!NOTE]
>
>Reportez-vous aux [Bonnes pratiques relatives au développement](/help/mobile/best-practices-aem-mobile.md) de modèles et de composants en AEM Mobile.
