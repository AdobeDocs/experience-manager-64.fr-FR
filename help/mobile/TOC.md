...
+ Développement d’une application On-Demand Services {#developing}
   ...
   + [Création de la configuration de l&#39;export des ressources partagées](creating-shared-resources-export-configuration.md)
   ...
   + [Création d’une configuration d’exportation d’article](creating-article-export-configuration.md)
   + [Mobile avec synchronisation de contenu](mobile-ondemand-contentsync.md)
...
+ Développement d’Adobe PhoneGap Enterprise {#developphonegap}
   ...
   + [Mobile avec synchronisation de contenu](phonegap-contentsync.md)
   + [Anatomie d’une application](phonegap-apps-arch.md)
   ...
   + [Création et modification d’applications à l’aide de la console Applications](phonegap-apps-console.md)
   + [Votre application hybride est-elle prête pour AEM Mobile ?](phonegap-adding-content-to-imported-app.md)
   + [Accès aux fonctionnalités du périphérique](phonegap-access-device-features.md)
   ...
   + [Suivi des performances de l’application avec Adobe Mobile Analytics](phonegap-intro-to-app-analytics.md)
