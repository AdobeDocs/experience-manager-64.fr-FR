...
Introduit pour la première fois dans la section body.jsp, template.jsp contient simplement les paramètres de la page. En mode publication, ce contenu est référencé directement (à l’adresse &lt;page-path>.template.html) et chargé dans l’application d’une seule page via l’URL templateUrl configurée sur $routeProvider.
...
Une fois que vous avez pris connaissance de l’anatomie d’une application, voir Applications [](/help/mobile/phonegap-single-page-applications.md)mono-page.
