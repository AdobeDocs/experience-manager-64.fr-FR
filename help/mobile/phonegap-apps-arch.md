...
seo-title: Anatomie d’une application
...
seo-description: 'Cette page fournit une description des composants de page que vous créez pour votre application, basée sur le composant /libs/mobileapps/components/angular/ng-page (CRXDE Lite sur un serveur local). '
...
Une fois que vous avez appris l’anatomie d’une application, voir [Applications sur une seule page](/help/mobile/phonegap-single-page-applications.md).
