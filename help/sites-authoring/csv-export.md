---
title: Exportation au format CSV
seo-title: Exportation au format CSV
...
# Exportation au format CSV{#export-to-csv}
...
1. Ouvrez la **console Sites**, accédez à l’emplacement requis si nécessaire.
