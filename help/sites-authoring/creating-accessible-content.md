...
* Photos illustratives : il s’agit de photos de personnes, d’objets ou de lieux. Pensez au rôle de la photo sur la page ; un équivalent textuel approprié risque d’être *Photo de [objet]*, mais peut dépendre du texte environnant.
...
* Bon exemple :
   ...
   * Texte : <u>Cours du soir de l&#39;automne 2010</u> - détails.
...
* Si une page est écrite en anglais (Royaume-Uni), l’élément `<html>` doit être : `<html lang = “en-gb”>`

* Alors qu’une page à restituer en anglais américain doit adopter la norme suivante : `<html lang = “en-us”>`
