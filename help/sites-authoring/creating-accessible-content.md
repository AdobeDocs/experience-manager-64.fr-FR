...
* **Listes d’utilisation** : vous pouvez utiliser du code HTML pour spécifier trois types de listes différents :
   ...
   * L’ `<ol>` élément est utilisé pour les listes *à* puces numérotées. Les éléments de liste individuels sont identifiés à l’aide de l’ `<li>` élément.
...
Vous pouvez également modifier le titre d’une page lors de la modification d’une page, accessible par **Informations sur la page** - **Propriétés.**
...
* [Compréhension du critère de réussite 3.1.2](https://www.w3.org/TR/2016/NOTE-UNDERSTANDING-WCAG20-20161007/meaning-other-lang-id.html)
...
![Bouton Image avec Texte de remplacement défini dans le champ Titre (boîte de dialogue d’édition).](assets/chlimage_1-208.png)
...
![Ajout d’élément au groupe de cases d’option. Le titre du groupe est « Contactez-moi avant le », défini dans le champ Titre.](assets/chlimage_1-209.png)
...
![Ajout d’informations supplémentaires (le mot obligatoire) pour les utilisateurs d’un lecteur d’écran dans le champ « Titre ».](assets/chlimage_1-210.png)
