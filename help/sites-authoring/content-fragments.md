...
1. Vous pouvez effectuer l’une des actions suivantes :
   ...
   * Ouvrir l’explorateur de **[!UICONTROL ressources]** et filtrer sur **[!UICONTROL Fragments de contenu]** (la valeur par défaut est Images). Faites ensuite glisser le fragment en question sur l’instance du composant.
