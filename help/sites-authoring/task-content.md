...
seo-title: Utilisation des tâches
...
# Utilisation des tâches{#working-with-tasks}
...
* **Liste des tâches :** lorsque vous cliquez sur le volet Tâche, une liste des tâches s’affiche. Cette liste contient des informations détaillées sur toutes les tâches liées au projet.
...
1. Dans le projet, accédez à la mosaïque **Tâches** et appuyez/cliquez sur l’icône +. La fenêtre **Ajouter une tâche** s’ouvre.
