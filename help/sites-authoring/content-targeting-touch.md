...
1. [Cible](#target-configuring-the-audiences): Spécifiez l’audience que chaque expérience cible. Vous pouvez cibler une audience spécifique et, si vous utilisez des tests A/B, déterminer le pourcentage de trafic qui va vers l’expérience.
...
Sélectionnez **ContextHub** comme moteur si vous utilisez le ciblage ContextHub. Voir [Configuration de ContextHub.](/help/sites-administering/contexthub-config.md)
