...
seo-description: Plusieurs raccourcis clavier sont disponibles dans AEM, notamment pour la modification de pages
...
|---|---|---|
| Tout mode de fenêtre de modification | `Ctrl-Shift-m` | Toggle between **Preview** and the currently selected [mode](/help/sites-authoring/author-environment-tools.md#page-modes)</a> (e.g. **Edit**, **Layout**, etc)* |
...
|  | `Ctrl-x` | Couper les paragraphes sélectionnés (les paragraphes coupés ne disparaîtront pas dans l’interface utilisateur tant qu’ils ne seront pas collés) |
...
>[!NOTE]
>
>&amp;ast; Once the user starts to interact with the page in Preview Mode, the `Ctrl-Shift-m` shortcut is no longer available. L’utilisateur doit cliquer sur la barre supérieure de l’éditeur ou revenir au mode Édition pour que le raccourci soit de nouveau disponible.
