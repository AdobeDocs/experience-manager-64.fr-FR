...
1. Dans votre projet de média, sélectionnez le signe **+** dans la mosaïque **Processus** et sélectionnez **Processus de demande de copie**.
...
1. Dans votre projet Simple, sélectionnez le signe **+** dans la mosaïque **Processus** et sélectionnez **Processus de demande Launch**.
