...
>[!NOTE]
>
>Gardez à l’esprit que si le SRP est laissé par défaut à [JSRP](jsrp.md), l’UGC saisi sur l’instance de publication n’est visible que lors de la publication et *ne sera pas *visible depuis la console de [modération](moderate-ugc.md) de l’instance d’auteur.
