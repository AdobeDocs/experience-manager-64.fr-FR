...
>[!NOTE]
>
>Gardez à l’esprit que si le SRP est laissé par défaut à [JSRP](jsrp.md), l’UGC saisi sur l’instance de publication ne sera visible que lors de la publication et *ne sera *pas visible à partir de la console [modération](moderate-ugc.md) de l’instance d’auteur.
