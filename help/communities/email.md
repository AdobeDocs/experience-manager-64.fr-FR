...
L’instance de configuration `AEM Communities Email Reply Configuration` OSGi avec le courrier électronique Nom est destinée à la fonction de notifications. Cette fonctionnalité n’inclut pas les réponses par courrier électronique.
