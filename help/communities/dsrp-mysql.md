...
Une fois le script exécuté, il est nécessaire d’actualiser la `SCHEMAS`section de la `Navigator` base de données pour afficher la nouvelle base de données. Utilisez l’icône Actualiser à droite de &quot;SCHÉMAS&quot; :
