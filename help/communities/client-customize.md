...
>[!CAUTION]
>
>Tout nom de classe CSS précédé du préfixe **scf-js-&amp;ast;** a une utilisation spécifique dans le code JavaScript. Ces classes affectent l’état d’un composant (par exemple, basculez de masqué à visible) et ne doivent pas être remplacées ni supprimées.
>
>Pendant que scf-js-&amp;ast; Les classes n’affectent pas les styles, les noms de classe peuvent être utilisés dans les feuilles de style avec l’avertissement que, lorsqu’elles contrôlent l’état des éléments, il peut y avoir des effets secondaires.
...
* /libs/social/&lt;feature>/components/hbs/&lt;nom du composant>/clientlibs
