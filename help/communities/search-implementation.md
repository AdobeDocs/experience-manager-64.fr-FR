...
Pour modifier des index existants ou créer des index personnalisés, reportez-vous aux sections [Requêtes Oak et Indexation](../../help/sites-deploying/queries-and-indexing.md).
...
Lors de l’ajout de propriétés personnalisées, afin que ces propriétés puissent être visibles pour les recherches et le tri créés avec l’[API de recherche UGC](#ugc-search-api), il est *obligatoire* d’ajouter un suffixe au nom de la propriété.
...
* [Refactorisation](socialutils.md)  de SocialUtils : méthodes utilitaires de SRP qui remplacent SocialUtils
