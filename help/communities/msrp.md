...
* Sélectionnez **[!UICONTROL MongoDB Enregistrement Resource Provider (MSRP)]**
...
#### JsonMappingException : id_fournisseur_champ non défini {#jsonmappingexception-undefined-field-provider-id}
