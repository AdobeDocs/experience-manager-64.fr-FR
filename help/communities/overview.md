...
[Assistant de création de site](sites-console.md) :

* Assemble les fonctionnalités du site, en fonction du [modèle de site communautaire](sites.md) sélectionné, à savoir :
   * Créé à partir des [fonctions de la communauté](#community-functions)
...
Pour découvrir la facilité de création rapide d’un site communautaire, consultez la section [Prise en main d’AEM Communities](getting-started.md).
...
* [Stockage de contenu de la communauté](working-with-srp.md) : présente les options de stockage SRP disponibles pour le contenu généré par l’utilisateur.
* [Topologies](topologies.md) recommandées : aborde les topologies en fonction du cas d’utilisation et du choix de la SRP
...
Dans l’environnement de création, la console de navigation globale permet d’accéder à la [console Communautés](consoles.md), qui contient :
...
* La console [Sites](sites-console.md)
   ...
   * Gestion de site
   * [console ](groups.md) Groupes communautaires
...
* [Consoles de gestion des membres et ](members.md) des groupes
...
* [Console ](tools.md#sitetemplatesconsole) Modèles du site

   * Créer et gérer des modèles de site de communauté

* [Console ](tools.md#grouptemplatesconsole) Modèles de groupe

   * Créer et gérer des modèles de groupes de communautés

* [console ](tools.md#communityfunctionsconsole) Fonctions de communauté
...
* [Guide du composant](components-guide.md)
   ...
   * Un exemple de site, [Composants de la communauté](http://localhost:4502/editor.html/content/community-components/en.html), qui fournit un exemple de tous les composants de communauté avec leur configuration par défaut et la possibilité de les tester.
...
Voir la [console Fonctions de communauté](functions.md).
...
Dans l’environnement de création, les groupes de communautés (sous-communautés) peuvent être créés dans un site de communauté existant ou imbriqués dans un groupe existant, lorsque la structure du modèle contient la [fonction Groupes](functions.md#groups-function).
...
* [Console Modèles de groupe](tools-groups.md)  : création de la structure de site pour les groupes
* [Prise en main d’AEM Communities](getting-started.md)  : tutoriel pour créer rapidement un site communautaire comprenant des groupes imbriqués.

## Composants de la communauté {#community-components}

Les [composants de communauté](author-communities.md) à partir desquels un site de communauté est créé peuvent être utilisés pour ajouter des fonctionnalités de communauté à n’importe quel site AEM.
...
Pour découvrir la facilité de création rapide d’une nouvelle communauté d’engagement, consultez la section [Prise en main d’AEM Communities](getting-started.md).
...
Une communauté d’activation peut être créée lorsque le module complémentaire [Activation est configuré](enablement.md), ce qui nécessite des licences supplémentaires pour une utilisation dans un environnement de production. Un site de la communauté d’activation comprend la fonction [Affectations](#community-functions).

Pour découvrir la facilité de création d’une communauté d’activation, consultez la section [Prise en main d’AEM Communities pour l’activation](getting-started-enablement.md).
...
* Scripts Apache ANT avec [propriétés](https://github.com/Adobe-Marketing-Cloud/aem-demo-machine/wiki/Properties) et [cibles](https://github.com/Adobe-Marketing-Cloud/aem-demo-machine/wiki/Command%20Line) configurables
* Packages à installer
AEM Demo Machine a été testé avec succès avec CQ 5.5, CQ 5.6.1, AEM 6.0, AEM 6.1, 6.2 et 6.3 sous Windows, MacOS et Linux.
