...
description: Ce guide couvre toutes les tâches AEM Communities, telles que la création d’expériences en ligne, telles que des forums, des groupes d’utilisateurs, des ressources d’apprentissage et d’autres fonctions sociales.
...
Ce guide couvre toutes les tâches AEM Communities, telles que la création d’expériences en ligne, telles que des forums, des groupes d’utilisateurs, des ressources d’apprentissage et d’autres fonctions sociales.
...
|--- |---|
| [Notes de mise à jour](/help/release-notes/home.md) | Fournit des informations importantes sur la dernière version d’AEM, notamment les nouveautés, les plates-formes prises en charge, les fonctionnalités obsolètes et supprimées et les problèmes connus |
