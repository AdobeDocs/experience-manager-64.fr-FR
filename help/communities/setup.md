...
Pour ce faire, suivez l’AEM de base [Prise en main](../../help/sites-deploying/deploy.md#getting-started) , ce qui entraîne
...
1. Installez un pack de correctifs ou [dernier Feature Pack](deploy-communities.md#latestfeaturepack) (pour les modifications de l’API Facebook de mars 2017)
