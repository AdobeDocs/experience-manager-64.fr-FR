...
Une aide par bloc qui teste la valeur actuelle du [mode WCM](https://helpx.adobe.com/fr/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) par rapport à une liste de modes séparés par des chaînes.
...
* **mode** : Chaîne
   ...
   (facultatif) Liste séparée par des virgules de [modes de gestion de contenu web](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) à tester si défini.
