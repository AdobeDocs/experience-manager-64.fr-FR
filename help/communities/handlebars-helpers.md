...
Aide de bloc qui teste la valeur actuelle de [mode WCM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) par rapport à une liste de modes séparée par des chaînes.
...
* **mode** : Chaîne
   ...
   (Facultatif) liste séparée par des virgules [de modes WCM](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/api/WCMMode.html) à tester si elle est définie.
...
* **contexte** : Chaîne ou objet
   ...
   utiliser `this.id` pour obtenir la ressource à `id` pour effectuer le rendu de la ressourceType demandée
