...
seo-title: Notions fondamentales sur la bibliothèque de fichiers
description: Utilisation de la fonctionnalité Bibliothèque de fichiers
seo-description: Utilisation de la fonctionnalité Bibliothèque de fichiers
...
Une structure de site de communauté qui comprend la fonction [Bibliothèque de fichiers](functions.md#file-library-function), comprend un composant `file library` configuré.
