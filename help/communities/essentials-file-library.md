...
<table> 
 <tbody>
  ...
  <tr>
   ...
   <td>Voir Fonctionnalité <a href="file-library.md">de la bibliothèque de fichiers</a></td> 
  </tr>
 </tbody>
</table>
...
Une structure de site de la communauté qui comprend la fonction [Bibliothèque de](functions.md#file-library-function)fichiers, comprend un `file library` composant configuré.
