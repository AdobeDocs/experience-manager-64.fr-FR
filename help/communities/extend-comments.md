...
Le composant de commentaire est en fait l&#39;un des deux composants qui composent le système de commentaires. Il y a donc deux composantes à étendre : *commentaires* et *commentaires*. Le script à modifier se trouve dans le `header.hbs` fichier du composant *comment *tandis que le composant de *commentaires* parent (le système de commentaires) est ce qu’un auteur ajoute effectivement à la page.
