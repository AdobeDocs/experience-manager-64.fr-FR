...
* [API de calendrier](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/calendar/client/api/package-summary.html)

* [Points de terminaison du calendrier](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/adobe/cq/social/calendar/client/endpoints/package-summary.html)

* [Personnalisations côté serveur](server-customize.md)

### Fonction Calendrier {#calendar-function}

Une structure de site communautaire qui inclut la fonction [Calendrier](functions.md#calendar-function) aura un composant c `alendar`configuré. La fonction Calendar prend en charge l&#39;identification d&#39;un [groupe d&#39;utilisateurs de membres privilégiés](users.md#privileged-members-group).
