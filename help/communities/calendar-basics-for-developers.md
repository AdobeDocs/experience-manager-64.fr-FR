...
Une structure de site communautaire qui inclut la fonction [](functions.md#calendar-function) Calendar aura un `alendar`composant c configuré. La fonction Calendar prend en charge l&#39;identification d&#39;un groupe [d&#39;utilisateurs membres](users.md#privileged-members-group)privilégiés.
