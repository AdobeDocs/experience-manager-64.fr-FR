...
1. Dans la navigation globale, sélectionnez **[!UICONTROL Outils > Cloud Services > Configuration]** de connexion à Twitter Social.
...
* Vérifier que le gestionnaire [d’authentification OAuth Granite](#adobe-granite-oauth-authentication-handler) Adobe a été activé sur toutes les instances de publication
...
1. Localisez l’application et le fournisseur OAuth Granite Adobe.
   ...
   * Localisez l’instance où l’ID **** client correspond à l’ID **[!UICONTROL d’application.]**
...
**&amp;ast;** Pour le **nom** oauthid-*123*, remplacez *123* par l’ID ***d’application Facebook ou la clé Twitter Consumer (API) qui est la valeur de l’ID de clientAdobe dans l’application OAuth Granite OAuth et la configuration de fournisseur de .*************[](social-login.md#adobe-granite-oauth-application-and-provider)
