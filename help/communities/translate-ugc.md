...
* **[!UICONTROL Configuration]**
 parente (Obligatoire) En règle générale, elle reste définie par défaut. La valeur par défaut est 
...
* **[!UICONTROL Nom]**
 (facultatif) Saisissez un nom pour la configuration. Par défaut, il s’agit d’un nom de noeud basé sur le titre.
...
* **** Assetstab : peut laisser comme valeurs par défaut
