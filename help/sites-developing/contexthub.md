...
ContextHub est un framework permettant de stocker, manipuler et présenter des données contextuelles. L’API Javascript côté client vous permet d’accéder aux données pour personnaliser le contenu.
...
* Utilisez AEM consoles pour [créer des magasins](/help/sites-administering/contexthub-config.md#creating-a-contexthub-store).
...
* Utilisez AEM consoles pour [ajout de modules d’IU](/help/sites-administering/contexthub-config.md#adding-a-ui-module)et à [les regrouper en modes d’interface utilisateur](/help/sites-administering/contexthub-config.md#adding-a-ui-mode).
