...
>
>HTL est désormais le langage de script recommandé pour AEM. See [HTL](https://helpx.adobe.com/fr/experience-manager/htl/user-guide.html) and [Developing AEM Components](/help/sites-developing/developing-components.md) to compare methods.
