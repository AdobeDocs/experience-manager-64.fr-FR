...
* **operation**
   ...
   &quot; `=`&quot; pour la correspondance exacte, &quot; `!=`&quot; pour la comparaison des inégalités, &quot; `>`&quot; pour property1 supérieure à property2, &quot; `>=`&quot; pour property1 supérieure ou égale à property2. La valeur par défaut est &quot; `=`&quot;.
...
format des dates et heures ( `YYYY-MM-DDTHH:mm:ss.SSSZ`) et permet également des représentations partielles, telles que `YYYY-MM-DD`. L’horodatage peut également être fourni sous la forme d’un nombre de millisecondes écoulées depuis 1970 dans le fuseau horaire UTC (format d’heure UNIX).
...
Recherche les éléments qui sont membres d’une [collection de ressources Sling](https://helpx.adobe.com/fr/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/org/apache/sling/resource/collection/ResourceCollection.html) spécifique.
