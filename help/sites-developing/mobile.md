...
AEM utilise une version tronquée de la variable [WURFL](http://wurfl.sourceforge.net/index.php)™ base de données pour interroger les fonctionnalités de l’appareil, telles que la résolution d’écran ou la prise en charge JavaScript, en fonction de l’agent utilisateur de l’appareil.
...
1. Une iPad envoie une requête à l’instance de publication AEM, par exemple `http://localhost:4503/content/geometrixx_mobile/en/products.html`
