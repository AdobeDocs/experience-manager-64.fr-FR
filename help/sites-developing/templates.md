...
>[!NOTE]
>
>Un article de la communauté AEM est disponible pour expliquer comment développer un site Experience Manager avec des modèles modifiables, voir [Création d’un site Web Adobe Experience Manager 6.4 à l’aide de modèles modifiables](https://helpx.adobe.com/experience-manager/using/first_aem64_website.html).
