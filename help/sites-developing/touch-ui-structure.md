...
Pour plus d’informations techniques, reportez-vous à la documentation [JS définie](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/jsdoc/ui-touch/editor-core/index.html) pour l’éditeur de page tactile.
