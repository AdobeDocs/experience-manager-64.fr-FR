...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td><p><code>String</code></p> <p>facultatif</p> <p>default: ""</p> </td> 
   <td>Texte qui fournit une description de la variation <span>(affichée dans l’onglet <strong>Variation</strong> de l’éditeur de fragments (rail gauche)).</span></td> 
  </tr> 
 </tbody> 
</table>
