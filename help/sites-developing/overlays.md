...
description: 'AEM applique le principe des incrustations pour vous permettre d’étendre et de personnaliser les consoles et d’autres fonctionnalités. '
...
* Incrustations non Granite et incrustations antérieures à AEM 6.0
   ...
   * Méthode
      ...
      * Copier le contenu de `/libs` vers `/apps`
...
* Deux utilisateurs du service ont besoin d’un accès JCR:READ à l’emplacement où les scripts sont stockés. Ces utilisateurs sont : components-search-service (utilisé par com.day.cq.wcm.coreto access/cache components) et sling-scripting (utilisé par org.apache.sling.servlets.resolver pour trouver des servlets).
* La configuration suivante doit également être configurée en fonction de l&#39;emplacement où vous avez placé vos scripts (dans cet exemple sous /etc, /libs ou /apps).
