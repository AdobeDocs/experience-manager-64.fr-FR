...
Un certain nombre de variables prédéfinies en Adobe Analytics peuvent être configurées sur une structure**. **Par défaut, les variables **charset**, **cookieLifetime**, **currencyCode** et **trackInlineStats** sont incluses dans la liste **Paramètres généraux d’analyse**.
