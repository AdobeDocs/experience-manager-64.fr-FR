...
>[!NOTE]
>
>Bien que l’outil Translator dispose d’une interface utilisateur classique, elle est utilisée pour la traduction d’expressions, quelle que soit l’interface dans laquelle ces expressions sont trouvées.
