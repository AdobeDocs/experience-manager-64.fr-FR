...
description: Ce tutoriel vous permet de créer un site web complet avec AEM
...
>[!CAUTION]
>
>Cet article décrit comment créer un site web à l’aide de JSP et en fonction de l’IU classique. Adobe vous recommande de tirer parti des technologies AEM les plus récentes pour vos sites Web. Vous en trouverez une description détaillée dans l’article [Prise en main du développement d’AEM Sites](/help/sites-developing/getting-started.md).
...
1. Dans l’arborescence de gauche de CRXDE Lite, cliquez avec le bouton droit de la souris sur le dossier **`/apps`**, puis cliquez sur **[!UICONTROL Créer > Créer Dossier]**. Dans la boîte de dialogue **Créer un dossier**, indiquez `mywebsite` comme nom de dossier, puis cliquez sur **OK**.
1. Cliquez avec le bouton droit de la souris sur le dossier `/apps/mywebsite`, puis cliquez sur **[!UICONTROL Créer > Créer un dossier]**. Dans la boîte de dialogue **[!UICONTROL Créer un dossier]**, indiquez `components` comme nom de dossier, puis cliquez sur **[!UICONTROL OK]**.
1. Cliquez avec le bouton droit de la souris sur le dossier `/apps/mywebsite`, puis cliquez sur **[!UICONTROL Créer > Créer un dossier]**. Dans la boîte de dialogue **[!UICONTROL Créer un dossier]**, indiquez `templates` comme nom de dossier, puis cliquez sur **[!UICONTROL OK]**.
...
>[!NOTE]
>
>Cliquez sur le lien suivant à télécharger ``mywebsite.zip``. L’archive contient le fichier static.css et les fichiers image nécessaires à votre conception.
...
1. Dans l’arborescence, sélectionnez le dossier **[!UICONTROL Conceptions]**, puis cliquez sur **[!UICONTROL Nouveau > Nouvelle page]**. Indiquez `mywebsite` comme titre, puis cliquez sur **[!UICONTROL Créer]**.
...
* Modèle contentpage qui sera utilisé pour créer des pages de contenu dans l’exemple de site web
* Composant contentpage qui sera utilisé pour effectuer le rendu des pages de contenu
...
1. Dans l’arborescence de CRXDE Lite, cliquez avec le bouton droit sur `/apps/mywebsite/templates`, puis cliquez sur **[!UICONTROL Créer > Créer un modèle]**.
...
1. Dans la boîte de dialogue Créer un modèle, saisissez les valeurs suivantes, puis cliquez sur **[!UICONTROL Suivant]**:
   ...
   * **[!UICONTROL Titre]**: Modèle de page de contenu de mon site web
   * **[!UICONTROL Description]**: Il s’agit du modèle de page de contenu de mon site web
...
1. Pour spécifier les chemins d’accès des pages qui utilisent ce modèle, cliquez sur le bouton Plus et saisissez ensuite `/content(/.*)?` dans la zone de texte qui apparaît. Cliquez ensuite sur **[!UICONTROL Suivant]**.

   ![chlimage_1-105](assets/chlimage_1-105.png)

   La valeur de la propriété de chemin autorisée est une *expression régulière.* Les pages dont le chemin d’accès correspond à cette expression peuvent utiliser le modèle. Dans ce cas, l’expression régulière correspond au chemin de la propriété `/content` et toutes les sous-pages.
...
1. Cliquez sur **[!UICONTROL Suivant]** dans le **[!UICONTROL Parents autorisés]** et **[!UICONTROL Enfants autorisés]** panneaux et cliquez sur **[!UICONTROL OK]**. Dans CRXDE Lite, cliquez sur **[!UICONTROL Enregistrer tout]**.
...
1. Dans CRXDE Lite, cliquez avec le bouton droit sur `/apps/mywebsite/components`, puis cliquez sur **[!UICONTROL Créer > Composant]**.
1. Dans la boîte de dialogue **[!UICONTROL Créer un composant]**, saisissez les valeurs de propriété suivantes :

   * **[!UICONTROL Libellé]**: contentpage
   * **[!UICONTROL Titre]**: Composant de page de contenu de mon site web
   * **[!UICONTROL Description]**: Ceci est le composant de page de contenu de mon site web
...
1. Cliquez sur **[!UICONTROL Suivant]****** jusqu’à ce que le panneau Enfants autorisés de la boîte de dialogue s’affiche. Cliquez ensuite sur **[!UICONTROL OK]**. Dans CRXDE Lite, cliquez sur **[!UICONTROL Enregistrer tout]**.
...
1. Sur la page d’accueil AEM ([http://localhost:4502/libs/cq/core/content/welcome.html](http://localhost:4502/libs/cq/core/content/welcome.html)), cliquez sur Sites Web.

   ![chlimage_1-109](assets/chlimage_1-109.png)

1. Dans l’arborescence, sélectionnez le dossier **[!UICONTROL Sites web]**, puis cliquez sur **[!UICONTROL Nouveau > Nouvelle page]**.
1. Dans la fenêtre **[!UICONTROL Créer une page]**, saisissez les informations suivantes :
   ...
   * Sélectionnez la **[!UICONTROL Modèle de page de contenu de mon site web]**
...
1. Pour lier vos pages à la conception mywebsite, sélectionnez le nœud `/content/mywebsite/en/jcr:content` dans CRXDE Lite. Sur le **[!UICONTROL Propriétés]** , saisissez les valeurs suivantes pour une nouvelle propriété, puis cliquez sur Ajouter :
...
Le **[!UICONTROL Produits]** se présente comme suit :
...
1. Dans votre navigateur, rechargez la page **[!UICONTROL Products]**. Il se présente comme suit :
...
1. Dans CRXDE Lite, créez le fichier `center.jsp` sous `/apps/mywebsite/components/contentpage` :
   ...
   1. Cliquez avec le bouton droit sur le nœud `/apps/mywebsite/components/contentpage`, puis sélectionnez **[!UICONTROL Créer]** et **[!UICONTROL Créer un fichier]**.
...
1. Dans CRXDE Lite, cliquez avec le bouton droit sur `/apps/mywebsite/components`, puis sélectionnez **[!UICONTROL Créer]** et **[!UICONTROL Créer un composant]**.
...
1. Cliquez sur **[!UICONTROL Suivant]** jusqu’à ce que la dernière fenêtre dans laquelle vous cliquez **[!UICONTROL OK]**. Enregistrez vos modifications.
...
1. Enregistrez les modifications.
1. Dans votre navigateur, rechargez la variable **[!UICONTROL Produits]** Page. La navigation supérieure s’affiche comme suit :
...
1. Dans votre navigateur, ouvrez la page **[!UICONTROL Products]**.
...
1. Répétez les étapes précédentes pour ajouter le sous-titre **about our services** à la page **[!UICONTROL Services]**.
1. Répétez les étapes précédentes pour ajouter le sous-titre **the trust we earn** à la page **[!UICONTROL Customers]**.
...
1. Copiez le code suivant dans `navimage.png.java.`Le code étend la classe AbstractImageServlet :
   ...
   * [AbstractImageServlet](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/wcm/commons/AbstractImageServlet.html) crée un objet ImageContext qui stocke les propriétés de la ressource active.
   ...
   * [ImageHelper](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/javadoc/com/day/cq/commons/ImageHelper.html) est utilisé pour générer l’image à partir du fichier navimage_bg.jpg de la conception du site, du titre de la page et du sous-titre de la page.
...
1. Enregistrez les modifications.
1. Dans votre navigateur, rechargez la page **[!UICONTROL Products]**. La navigation supérieure s’affiche désormais comme suit :
...
Créez deux pages situées sous la section **[!UICONTROL Produits]** page. Pour chaque page, qui décrit deux produits spécifiques, vous définissez un titre, une description et une date.
...
1. Dans CRXDE Lite, définissez une description et une date pour la page Product 1 :
   ...
   1. Dans le **[!UICONTROL Propriétés]** , créez une autre propriété à l’aide des valeurs suivantes :
...
1. Créez le nœud de boîte de dialogue sous le composant listchildren :
   ...
   1. Dans CRXDE Lite, cliquez avec le bouton droit sur le nœud `/apps/mywebsite/components/listchildren`, puis cliquez sur **[!UICONTROL Créer > Créer une boîte de dialogue]**.
   1. Dans la boîte de dialogue, entrez les valeurs de propriété ci-dessous et cliquez ensuite sur OK.

      * **[!UICONTROL Libellé]** : `dialog`
      * **[!UICONTROL Titre]** : `Edit Component`. Cliquez ensuite sur **[!UICONTROL OK]**.
...
1. Ajoutez des propriétés au nœud listroot afin de le configurer comme champ de texte. Chaque ligne du tableau suivant représente une propriété. Lorsque vous avez terminé, cliquez sur **[!UICONTROL Enregistrer tout]**.
...
1. Dans votre navigateur, rechargez la page **[!UICONTROL Products]**. Le composant listchildren apparaît comme suit :

   ![chlimage_1-118](assets/chlimage_1-118.png)

1. ![chlimage_1-119](assets/chlimage_1-119.png)

1. Pour Path of list root, saisissez : `/content/mywebsite/en`. Cliquez sur **[!UICONTROL OK]**. Le composant listchildren de votre page se présente désormais comme suit :
...
1. Cliquez sur Suivant jusqu’à ce que vous accédiez au panneau final de la boîte de dialogue, puis cliquez sur **[!UICONTROL OK]**.
...
1. Créez le nœud de boîte de dialogue sous le composant Logo :
   ...
   1. Cliquez avec le bouton droit de la souris sur le nœud `/apps/mywebsite/components/logo`, puis cliquez sur **[!UICONTROL Créer > Créer une boîte de dialogue]**.
...
1. Cliquez avec le bouton droit sur le noeud tab1 dans la branche design_dialog et cliquez sur Supprimer. Cliquez sur **[!UICONTROL Enregistrer tout]**.
1. Sous le nœud `design_dialog/items/items`, créez un nœud nommé `img` du type `cq:Widget`. Ajoutez les propriétés suivantes, puis cliquez sur **[!UICONTROL Enregistrer tout]**:
...
1. Enregistrez les modifications.
1. Dans votre navigateur, rechargez la variable **[!UICONTROL Produits 1]** page. Le composant Suivi se présente comme suit :
...
1. Dans votre navigateur, actualisez la variable **[!UICONTROL Produits]** page. Il comporte désormais le composant parsys, qui se présente comme suit :
...
1. Cliquez avec le bouton droit sur le nœud `/apps/mywebsite/components/logo`**[!UICONTROL , puis cliquez sur Copier]**.
1. Cliquez avec le bouton droit sur le nœud `/apps/mywebsite/components`**[!UICONTROL , puis cliquez sur Coller]**.
...
1. Dans CRXDE Lite, cliquez avec le bouton droit sur le fichier `/libs/foundation/components/image/icon.png`, puis sélectionnez **[!UICONTROL Copier]**.
1. Cliquez avec le bouton droit sur le nœud `/apps/mywebsite/components/image`, puis cliquez sur **[!UICONTROL Coller]** puis sur **[!UICONTROL Enregistrer tout]**.
...
1. Dans la boîte de dialogue, une liste de **[!UICONTROL Composants autorisés]** s’affiche ; accéder à **[!UICONTROL MyWebsite]**, sélectionnez la variable **[!UICONTROL Mon composant d’image]** et cliquez sur **[!UICONTROL OK]**.
1. Revenir à **[!UICONTROL Mode d’édition]**.
1. Double-cliquez sur le cadre du système de paragraphes (activé) **[!UICONTROL Faire glisser des composants ou des ressources ici]**). Le **[!UICONTROL Insérer un nouveau composant]** et **[!UICONTROL Sidekick]** les sélecteurs se présentent comme suit :
...
1. Dans l’arborescence de dossiers de la page Sites Web AEM, sélectionnez `Websites/My Website/English`, puis cliquez sur **[!UICONTROL Nouveau > Nouvelle page]**. Spécifiez les valeurs de propriété suivantes, puis cliquez sur Créer :
...
1. Dans votre navigateur, rechargez la page **[!UICONTROL Products]**. Le composant de recherche se présente comme suit :
...
1. Dans la boîte de dialogue, faites défiler la liste vers le bas jusqu’au groupe **[!UICONTROL Mes sites web]**, sélectionnez **[!UICONTROL Mon composant de recherche]**, puis cliquez sur **[!UICONTROL OK]**.
1. Dans le sidekick, cliquez sur le triangle pour revenir à **[!UICONTROL Modifier]** mode .
1. Faites glisser le **[!UICONTROL Ma recherche]** du sidekick vers le cadre parsys. Il se présente comme suit :
...
1. Enregistrez les modifications.
1. Dans votre navigateur, rechargez la page **[!UICONTROL Products]**. La page se présente comme suit :
