...
Au niveau d’AEM Foundation, les données personnelles stockées sont le profil utilisateur. Par conséquent, les informations fournies dans cet article expliquent principalement comment accéder à ces profils utilisateur et les supprimer pour répondre respectivement aux demandes d’accès et de suppression dans le cadre du RGPD.
...
1. Enfin, confirmez l’action :
   ...
   L’interface utilisateur indique alors que l’utilisateur a été désactivé en grisé et en ajoutant un verrou à la carte de profil :
