...
>[!NOTE]
>
>Tout le contenu de la campagne doit être créé sous une page `master` de type `cq/personalization/components/ambitpage`. Par exemple, si vous planifiez une structure de campagne, procédez comme suit :
>
