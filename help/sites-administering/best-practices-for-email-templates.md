...
>[!NOTE]
>
>Tout le contenu de la campagne doit être créé sous une `master` page de type `cq/personalization/components/ambitpage`. Par exemple, si vous planifiez une structure de campagne, vous pouvez effectuer les opérations suivantes :
>
