...
1. En supposant que le serveur de portail s&#39;exécute sur l&#39;hôte **localhost**, **port 8080 **et que l&#39;application Web du portlet AEM soit montée dans le contexte **cqportlet**, l&#39;URL pour vider le cache est `http://localhost:8080/cqportlet/cqbridge/cqpcache?Path=$(path)`. Utilisez la méthode GET.
