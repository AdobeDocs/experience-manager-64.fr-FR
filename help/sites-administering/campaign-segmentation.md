...
1. Appuyez sur les touches **[Ctrl-Alt-C](/help/sites-authoring/keyboard-shortcuts.md)** pour ouvrir le **[ClientContext](/help/sites-administering/client-context.md)**, qui affiche les données collectées. À des fins de test, vous pouvez **Modifier** certaines valeurs, ou **Chargement** un autre profil pour voir l&#39;impact.
