...
Toutes les configurations LDAP sont désormais disponibles en tant que configurations OSGi. Ils peuvent être configurés via la console Web Management à l’adresse suivante :\
...
>
>Pour lire un exemple de configuration d’Experience Manager avec Apache DS, voir [Configuration d’Adobe Experience Manager 6.4 pour l’utilisation d’Apache Directory Service](https://helpx.adobe.com/experience-manager/using/configuring-aem64-apache-directory-service.html) (en anglais).
