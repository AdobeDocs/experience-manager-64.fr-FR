...
JSPs cannot use `loginService()`, because there is no associated service. Cependant, les sessions administratives dans les JSP sont généralement le signe d&#39;une violation du paradigme du MVC.
