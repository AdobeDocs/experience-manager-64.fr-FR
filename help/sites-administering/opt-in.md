...
1. Pour Target :
   ...
   1. Saisissez les informations du compte utilisateur pour Target, puis cliquez sur le lien correspondant. **Ajouter** bouton .
...
* analytics.company : Société associée à votre compte utilisateur Analytics.
* analytics.username : Votre nom d’utilisateur Analytics.
* analytics.secret: Le secret associé à votre nom d’utilisateur Analytics.
...
## À propos des configurations du cloud {#about-the-cloud-configurations}
