...
![managing_tags_using_thetagasAdministration Console](assets/managing_tags_usingthetagasministrationconsole.png)
...
Lorsqu’un espace de nommage ou une autre balise est sélectionné, la sélection de l’icône **`References`**identifie le contenu auquel la balise a été appliquée.
...
Lorsqu’un espace de nommage ou une autre balise est sélectionné, la sélection de l’icône **`Merge`**ouvre un panneau dans lequel le chemin de fusion peut être sélectionné.
...
>[!NOTE]
>
>Après la fusion, le **Path **sélectionné initialement n&#39;existera (virtuellement) plus.
>
...
Lorsqu’un espace de nommage ou une autre balise est sélectionné, sélectionnez l’icône **`Publish`**pour activer la balise dans l’environnement de publication. De même que pour le contenu d’une page, seule la balise sélectionnée est publiée, qu’il s’agisse d’une balise conteneur ou non.
...
Une fois toutes les traductions entrées, sélectionnez **Enregistrer **pour quitter le mode d&#39;édition.
