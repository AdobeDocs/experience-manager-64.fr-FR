...
seo-description: Découvrez comment intégrer et utiliser Livefyre avec AEM 6.4.
...
1. Installez le package téléchargé à partir du gestionnaire de modules. Pour obtenir des instructions sur l’utilisation de la distribution logicielle et des packages dans AEM, voir [Comment utiliser les packages](/help/sites-administering/package-manager.md).
