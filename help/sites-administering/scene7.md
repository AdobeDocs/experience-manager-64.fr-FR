...
1. Si vous souhaitez que les ressources AEM soient automatiquement transférées vers Dynamic Media Classic, vous devez activer cette option et ajouter Dynamic Media Classic au processus de mise à jour de la gestion des actifs numériques. Vous pouvez également télécharger les ressources manuellement.
