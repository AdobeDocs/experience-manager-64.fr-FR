...
1. Si vous souhaitez que AEM ressources soient automatiquement téléchargées vers Dynamic Media Classic, vous devez activer cette option et ajouter Dynamic Media Classic au processus de mise à jour de la gestion des actifs numériques. Vous pouvez également télécharger les ressources manuellement.
...
1. Dans le sidekick, accédez aux composants **[!UICONTROL Workflow]**, puis sélectionnez **[!UICONTROL Dynamic Media Classic]**. Faites glisser **[!UICONTROL Dynamic Media Classic]** vers le flux de travaux et appuyez sur **[!UICONTROL Enregistrer]**. Les ressources ajoutées à AEM Assets dans le dossier cible seront automatiquement téléchargées vers Dynamic Media Classic.
