...
* p1 : A `String` qui représente le message à afficher. L’illustration suivante montre le résultat de l’appel de `log` avec une valeur p1 de `this is a log message`.
