...
Pour localiser la configuration du cloud et la structure, accédez à **Cloud Services** par **Outils** > **Déploiement** > **Cloud**. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
...
1. Cliquez sur **Se connecter à Target** pour lancer la connexion à Target. Si la connexion réussit, le message** Connection success*** s’affiche. Cliquez sur **OK** dans le message et **OK** dans la boîte de dialogue.
...
1. Dans la boîte de dialogue Créer un cadre, spécifiez un **titre**, sélectionnez le **cadre Adobe Target**, puis cliquez sur **Créer**.
   ...
   La page de structure s’ouvre. Sidekick fournit des composants qui représentent les informations provenant du [contexte client](/help/sites-administering/client-context.md) ou [ContextHub](/help/sites-administering/contexthub-config.md) que vous pouvez mapper.
