...
Vous pouvez également choisir de spécifier le mot de passe dans un fichier de propriétés. This is done by using the `-nointeractive` flag combined with the `-Dadmin.password.file` system property.
