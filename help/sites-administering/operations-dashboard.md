...
1. **Révision Nettoyage **tâche, situé sous le menu **Quotidien Maintenance Window**.

1. **Lucene Binaries Cleanup **tâche, situé sous le menu **Daily Maintenance Window**.

1. La **purge de flux de travail **tâche, située sous le menu **Fenêtre de maintenance hebdomadaire**.
